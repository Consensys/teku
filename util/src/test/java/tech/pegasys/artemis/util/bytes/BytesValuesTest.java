...
import static tech.pegasys.artemis.util.bytes.BytesValues.asSignedBigInteger;
import static tech.pegasys.artemis.util.bytes.BytesValues.asUnsignedBigInteger;
import static tech.pegasys.artemis.util.bytes.BytesValues.concatenate;
import static tech.pegasys.artemis.util.bytes.BytesValues.extractInt;
import static tech.pegasys.artemis.util.bytes.BytesValues.extractLong;
import static tech.pegasys.artemis.util.bytes.BytesValues.ofUnsignedShort;
import static tech.pegasys.artemis.util.bytes.BytesValues.toMinimalBytes;
...
public class BytesValuesTest {
    ...
    public void unsignedBigInteger() {
        ...
        // 2^100 is a one followed by 100 zeros, that's 12 bytes of zeros (=96) plus 4 more zeros
        // (so
        // 0x10 == 16).
