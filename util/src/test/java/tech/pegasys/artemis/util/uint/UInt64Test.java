...
public class UInt64Test {
    ...
    private void subtract(long minuend, long subtrahend, String expectedDifference) {
        ...
        try {
            ...
            Assert.assertEquals(
                    "UInt64 Difference", UInt64.valueOf(expectedDifference), longDifference);
            ...
            Assert.assertEquals(
                    "UInt64 Difference", UInt64.valueOf(expectedDifference), uintDifference);
        } catch (Exception e) {
            thrown = true;
        }
    ...
    private void divideExpectException(
        ...
        try {
            ...
            Assert.assertTrue(
                    ...
                    e.getMessage().equals("Argument 'divisor' is 0."));
        }
    }
        ...
        try {
            ...
            if (isModulo) {
                ...
                Assert.assertEquals(
                        "Quotient",
                        expectedQuotient,
                        Long.toUnsignedString(longQuotient.getValue()));
                Assert.assertEquals(
                        "UInt64 Modulo Result", UInt64.valueOf(expectedQuotient), longQuotient);
                ...
                Assert.assertEquals(
                        "Quotient",
                        expectedQuotient,
                        Long.toUnsignedString(uintQuotient.getValue()));
                Assert.assertEquals(
                        "UInt64 Modulo Result", UInt64.valueOf(expectedQuotient), uintQuotient);
            } else {
                UInt64 longQuotient = uDividend.dividedBy(divisor);
                Assert.assertEquals(
                        "Quotient",
