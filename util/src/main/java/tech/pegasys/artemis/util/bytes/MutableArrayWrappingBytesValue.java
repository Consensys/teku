...
class MutableArrayWrappingBytesValue extends ArrayWrappingBytesValue implements MutableBytesValue {
    ...
    public void set(int i, byte b) {
        // Check bounds because while the array access would throw, the error message would be
        // confusing
        // for the caller.
    ...
    public BytesValue copy() {
        // We *must* override this method because ArrayWrappingBytesValue assumes that it is the
        // case.
