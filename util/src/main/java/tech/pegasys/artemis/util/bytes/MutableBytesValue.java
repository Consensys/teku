...
public interface MutableBytesValue extends BytesValue {
     ...
     * MutableBytesValue} is required, it is effectively immutable since empty and thus having
     * nothing to mutate.
     */
     ...
     * reflected in the returned value, and any change to the returned value will be reflected in
     * the buffer.
     *
