...
public class NoOpValidatorIndexCacheBenchmark {

  private static final int VALIDATORS_MAX_IDX = 399_999;
  ...
  private static final ValidatorIndexCache CACHE = ValidatorIndexCache.NO_OP_INSTANCE;
