...
public class ValidatorClientService extends Service {
  ...
  private ValidatorClientService(
    ...
    asyncRunner.runAsync(() -> initializeValidators(config, validatorApiChannel, asyncRunner, serviceConfig));
  }
  ...
  SafeFuture<Void> initializeValidators(ValidatorClientConfiguration config,
  ...
  protected SafeFuture<?> doStart() {
    return initializationComplete.thenCompose((__) -> {
