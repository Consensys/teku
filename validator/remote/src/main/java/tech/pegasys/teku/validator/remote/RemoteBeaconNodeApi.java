...
public class RemoteBeaconNodeApi implements BeaconNodeApi {
  ...
  private static RemoteValidatorApiChannel createRemoteValidatorApi(
    ...
    final OkHttpValidatorTypeDefClient typeDefClient =
        new OkHttpValidatorTypeDefClient(apiEndpoint, okHttpClient, spec, preferSszBlockEncoding);
    return new RemoteValidatorApiHandler(spec, apiEndpoint, apiClient, typeDefClient, asyncRunner);
  }
}
