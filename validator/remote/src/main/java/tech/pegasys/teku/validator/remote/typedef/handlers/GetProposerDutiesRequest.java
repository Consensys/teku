...
import static tech.pegasys.teku.ethereum.json.types.SharedApiTypes.GET_PROPOSER_DUTIES_TYPE;
...
public class GetProposerDutiesRequest extends AbstractTypeDefRequest {
  public GetProposerDutiesRequest(final OkHttpClient okHttpClient, final HttpUrl baseEndpoint) {
  ...
  public Optional<ProposerDuties> getProposerDuties(final UInt64 epoch) {
    return get(
        ...
        Map.of(),
        new ResponseHandler<>(GET_PROPOSER_DUTIES_TYPE));
  }
}
