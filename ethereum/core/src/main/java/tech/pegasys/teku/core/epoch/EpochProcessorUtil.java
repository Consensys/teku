...
import static tech.pegasys.teku.spec.datastructures.util.BeaconStateUtil.all;
import static tech.pegasys.teku.spec.datastructures.util.BeaconStateUtil.compute_activation_exit_epoch;
import static tech.pegasys.teku.spec.datastructures.util.BeaconStateUtil.get_block_root;
...
import static tech.pegasys.teku.spec.datastructures.util.BeaconStateUtil.get_randao_mix;
import static tech.pegasys.teku.spec.datastructures.util.BeaconStateUtil.get_validator_churn_limit;
import static tech.pegasys.teku.spec.datastructures.util.BeaconStateUtil.initiate_validator_exit;
import static tech.pegasys.teku.spec.datastructures.util.ValidatorsUtil.decrease_balance;
import static tech.pegasys.teku.spec.datastructures.util.ValidatorsUtil.is_eligible_for_activation;
