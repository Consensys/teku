...
public class EngineNewPayloadV6 extends AbstractEngineJsonRpcMethod<PayloadStatus> {

  private static final Logger LOG = LogManager.getLogger();

  public EngineNewPayloadV6(final ExecutionEngineClient executionEngineClient) {
  ...
  public SafeFuture<PayloadStatus> execute(final JsonRpcRequestParams params) {
    ...
    final List<Bytes> inclusionListTransactions = params.getRequiredListParameter(4, Bytes.class);

    LOG.trace(
        "Calling {}(executionPayload={}, blobVersionedHashes={}, parentBeaconBlockRoot={},"
            + " executionRequests={}, inclusionListTransactions={})",
        getVersionedName(),
        executionPayload,
        blobVersionedHashes,
