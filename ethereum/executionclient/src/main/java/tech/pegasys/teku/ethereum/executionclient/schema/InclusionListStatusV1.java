...
public class InclusionListStatusV1 {
  ...
  public InclusionListStatus asInternalExecutionPayload() {
    return InclusionListStatus.create(status, Optional.ofNullable(validationError));
  }
  ...
  public boolean equals(final Object o) {
    ...
    final InclusionListStatusV1 that = (InclusionListStatusV1) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, validationError);
  }
