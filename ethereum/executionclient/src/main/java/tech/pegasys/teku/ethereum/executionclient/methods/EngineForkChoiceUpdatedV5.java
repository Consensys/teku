...
public class EngineForkChoiceUpdatedV5
  ...
  public EngineForkChoiceUpdatedV5(final ExecutionEngineClient executionEngineClient) {
  ...
  public SafeFuture<tech.pegasys.teku.spec.executionlayer.ForkChoiceUpdatedResult> execute(
    ...
    final Optional<PayloadAttributesV5> maybePayloadAttributes =
        payloadBuildingAttributes.map(PayloadAttributesV5::fromInternalPayloadBuildingAttributesV5);
