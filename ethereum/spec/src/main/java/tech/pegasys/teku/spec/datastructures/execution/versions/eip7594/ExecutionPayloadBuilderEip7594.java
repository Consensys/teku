...
public class ExecutionPayloadBuilderEip7594 extends ExecutionPayloadBuilderDeneb {
  private ExecutionPayloadSchemaEip7594 schema;

  public ExecutionPayloadBuilderEip7594 schema(final ExecutionPayloadSchemaEip7594 schema) {
    this.schema = schema;
    return this;
  }
  ...
  public ExecutionPayload build() {
    validate();
    return new ExecutionPayloadEip7594Impl(
        schema,
