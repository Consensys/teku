...
public class MetadataMessageMerge extends Container2<MetadataMessageMerge, SszUInt64, SszBitvector>
    implements MetadataMessage {

  MetadataMessageMerge(MetadataMessageSchemaMerge type, TreeNode backingNode) {
    super(type, backingNode);
  }

  MetadataMessageMerge(MetadataMessageSchemaMerge type) {
    super(type);
  }

  MetadataMessageMerge(MetadataMessageSchemaMerge schema, UInt64 seqNumber, SszBitvector attnets) {
