...
public class BeaconStateSchemaElectra
  ...
  BeaconStateSchemaElectra(
      final SpecConfig specConfig, final ExecutionWitnessSchema executionWitnessSchema) {
    super("BeaconStateElectra", getUniqueFields(specConfig, executionWitnessSchema), specConfig);
  }
        ...
        new SszField(
            ...
            () ->
                new ExecutionPayloadHeaderSchemaElectra(
                    SpecConfigElectra.required(specConfig), executionWitnessSchema));
  ...
  public static BeaconStateSchemaElectra create(
      final SpecConfig specConfig, final ExecutionWitnessSchema executionWitnessSchema) {
    return new BeaconStateSchemaElectra(specConfig, executionWitnessSchema);
  }
  ...
  @Override
  public BeaconStateElectra createFromBackingNode(TreeNode node) {
