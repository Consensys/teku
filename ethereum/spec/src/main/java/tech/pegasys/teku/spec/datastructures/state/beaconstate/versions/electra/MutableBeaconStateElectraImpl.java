...
public class MutableBeaconStateElectraImpl
  ...
  MutableBeaconStateElectraImpl(BeaconStateElectraImpl backingImmutableView) {
    super(backingImmutableView);
  }

  MutableBeaconStateElectraImpl(BeaconStateElectraImpl backingImmutableView, boolean builder) {
  ...
  protected BeaconStateElectraImpl createImmutableBeaconState(
    ...
    return new BeaconStateElectraImpl(getSchema(), backingNode, viewCache, transitionCache);
  }
