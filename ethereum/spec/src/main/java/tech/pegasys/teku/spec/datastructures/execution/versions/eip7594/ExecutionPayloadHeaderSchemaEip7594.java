...
public class ExecutionPayloadHeaderSchemaEip7594
    extends ContainerSchema17<
        ...
        SszUInt64,
        SszUInt64>
    implements ExecutionPayloadHeaderSchema<ExecutionPayloadHeaderEip7594Impl> {

  private final ExecutionPayloadHeaderEip7594Impl defaultExecutionPayloadHeader;
  private final ExecutionPayloadHeaderEip7594Impl executionPayloadHeaderOfDefaultPayload;

  public ExecutionPayloadHeaderSchemaEip7594(final SpecConfigEip7594 specConfig) {
    super(
    ...
    final ExecutionPayloadEip7594Impl defaultExecutionPayload =
        new ExecutionPayloadSchemaEip7594(specConfig).getDefault();
  ...
  public ExecutionPayloadHeader createExecutionPayloadHeader(
    ...
    final ExecutionPayloadHeaderBuilderEip7594 builder =
        new ExecutionPayloadHeaderBuilderEip7594().schema(this);
    builderConsumer.accept(builder);
    return builder.build();
  }

  @Override
  public ExecutionPayloadHeaderEip7594Impl getDefault() {
    return defaultExecutionPayloadHeader;
  }

  @Override
  public ExecutionPayloadHeaderEip7594 getHeaderOfDefaultPayload() {
    return executionPayloadHeaderOfDefaultPayload;
  }

  @Override
  public ExecutionPayloadHeaderEip7594Impl createFromBackingNode(final TreeNode node) {
    return new ExecutionPayloadHeaderEip7594Impl(this, node);
  }

  @Override
  public ExecutionPayloadHeaderEip7594Impl createFromExecutionPayload(
      final ExecutionPayload payload) {
    final ExecutionPayloadEip7594 executionPayload = ExecutionPayloadEip7594.required(payload);
