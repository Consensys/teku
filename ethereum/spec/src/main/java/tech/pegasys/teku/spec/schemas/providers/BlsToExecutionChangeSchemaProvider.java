...
public class BlsToExecutionChangeSchemaProvider
  ...
  public BlsToExecutionChangeSchemaProvider() {
    super(BLS_TO_EXECUTION_CHANGE_SCHEMA);
    addMilestoneMapping(CAPELLA, SpecMilestone.getHighestMilestone());
  }

  @Override
  protected BlsToExecutionChangeSchema createSchema(
      final SchemaRegistry registry,
      final SpecMilestone effectiveMilestone,
      final SpecConfig specConfig) {
    return new BlsToExecutionChangeSchema();
  }
