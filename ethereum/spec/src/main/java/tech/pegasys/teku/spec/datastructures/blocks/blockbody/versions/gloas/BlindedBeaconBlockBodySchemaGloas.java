...
public interface BlindedBeaconBlockBodySchemaGloas<T extends BlindedBeaconBlockBodyGloas>
  ...
  static BlindedBeaconBlockBodySchemaGloas<?> required(final BeaconBlockBodySchema<?> schema) {
    checkArgument(
        schema instanceof BlindedBeaconBlockBodySchemaGloas,
        "Expected a BlindedBeaconBlockBodySchemaGloas but was %s",
        schema.getClass());
