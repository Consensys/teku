...
public class ExecutionPayloadSchemaEip7732
    extends ContainerSchema17<
        ...
        SszUInt64,
        SszUInt64>
    implements ExecutionPayloadSchema<ExecutionPayloadEip7732Impl> {

  private final ExecutionPayloadEip7732Impl defaultExecutionPayload;

  public ExecutionPayloadSchemaEip7732(final SpecConfigEip7732 specConfig) {
    super(
        "ExecutionPayloadEip7732",
  ...
  @Override
  public ExecutionPayloadEip7732Impl getDefault() {
  ...
  public ExecutionPayload createExecutionPayload(
    ...
    final ExecutionPayloadBuilderEip7732 builder =
        new ExecutionPayloadBuilderEip7732().schema(this);
    builderConsumer.accept(builder);
    return builder.build();
  }

  @Override
  public ExecutionPayloadEip7732Impl createFromBackingNode(final TreeNode node) {
    return new ExecutionPayloadEip7732Impl(this, node);
  }
