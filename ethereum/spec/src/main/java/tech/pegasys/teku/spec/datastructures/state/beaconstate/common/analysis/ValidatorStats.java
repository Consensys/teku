...
package tech.pegasys.teku.spec.datastructures.state.beaconstate.common.analysis;

import org.apache.tuweni.bytes.Bytes32;

public interface ValidatorStats {
  CorrectAndLiveValidators getValidatorStatsPreviousEpoch(final Bytes32 correctTargetRoot);

  CorrectAndLiveValidators getValidatorStatsCurrentEpoch(final Bytes32 correctTargetRoot);

  class CorrectAndLiveValidators {
