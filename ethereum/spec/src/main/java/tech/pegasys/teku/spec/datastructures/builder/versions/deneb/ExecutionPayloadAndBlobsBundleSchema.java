...
public class ExecutionPayloadAndBlobsBundleSchema
    extends ContainerSchema2<ExecutionPayloadAndBlobsBundle, ExecutionPayload, BlobsBundleDeneb>
  ...
  public ExecutionPayloadAndBlobsBundleSchema(final SchemaRegistry schemaRegistry) {
    super(
        ...
        namedSchema(
            "blobs_bundle", (SszSchema<BlobsBundleDeneb>) schemaRegistry.get(BLOBS_BUNDLE_SCHEMA)));
  }
  ...
  public ExecutionPayloadAndBlobsBundle create(
      final ExecutionPayload executionPayload, final BlobsBundleDeneb blobsBundle) {
