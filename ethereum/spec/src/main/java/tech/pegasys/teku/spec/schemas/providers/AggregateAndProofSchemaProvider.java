...
public class AggregateAndProofSchemaProvider
  ...
  public AggregateAndProofSchemaProvider() {
    super(AGGREGATE_AND_PROOF_SCHEMA);
  }

  @Override
  protected AggregateAndProofSchema createSchema(
      final SchemaRegistry registry,
      final SpecMilestone effectiveMilestone,
      final SpecConfig specConfig) {
    return new AggregateAndProofSchema(registry.get(ATTESTATION_SCHEMA));
  }
