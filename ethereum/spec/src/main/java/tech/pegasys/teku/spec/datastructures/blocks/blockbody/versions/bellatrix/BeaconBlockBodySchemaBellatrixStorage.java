...
public class BeaconBlockBodySchemaBellatrixStorage
  ...
  private BeaconBlockBodySchemaBellatrixStorage(
      ...
      NamedSchema<SszBytes32> executionPayloadSchema) {
    super(
        containerName,
        randaoRevealSchema,
        eth1DataSchema,
  ...
  public static BeaconBlockBodySchemaBellatrixStorage create(
      final SpecConfigBellatrix specConfig,
      final AttesterSlashingSchema attesterSlashingSchema,
      final String containerName) {
    return new BeaconBlockBodySchemaBellatrixStorage(
        containerName,
        ...
        namedSchema(BlockBodyFields.EXECUTION_PAYLOAD, SszPrimitiveSchemas.BYTES32_SCHEMA));
  }

  @Override
  public BeaconBlockBodyBellatrixStorage createFromBackingNode(TreeNode node) {
    return new BeaconBlockBodyBellatrixStorage(this, node);
  }
}
