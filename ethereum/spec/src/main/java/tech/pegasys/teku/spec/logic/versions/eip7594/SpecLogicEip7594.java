...
import tech.pegasys.teku.spec.logic.versions.eip7594.block.BlockProcessorEip7594;
import tech.pegasys.teku.spec.logic.versions.eip7594.forktransition.Eip7594StateUpgrade;
...
public class SpecLogicEip7594 extends AbstractSpecLogic {
  ...
  public static SpecLogicEip7594 create(
      final SpecConfigEip7594 config, final SchemaDefinitionsEip7594 schemaDefinitions) {
    // Helpers
    final Predicates predicates = new Predicates(config);
    final MiscHelpersEip7594 miscHelpers =
        new MiscHelpersEip7594(config, predicates, schemaDefinitions);
    ...
    // State upgrade
    final Eip7594StateUpgrade stateUpgrade =
        new Eip7594StateUpgrade(config, schemaDefinitions, beaconStateAccessors);
