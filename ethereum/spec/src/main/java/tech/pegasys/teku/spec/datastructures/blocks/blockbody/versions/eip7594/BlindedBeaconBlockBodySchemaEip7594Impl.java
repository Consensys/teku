...
public class BlindedBeaconBlockBodySchemaEip7594Impl
    ...
    implements BlindedBeaconBlockBodySchemaEip7594<BlindedBeaconBlockBodyEip7594Impl> {

  private BlindedBeaconBlockBodySchemaEip7594Impl(
      ...
      final NamedSchema<ExecutionPayloadHeaderEip7594Impl> executionPayloadHeader,
  ...
  public static BlindedBeaconBlockBodySchemaEip7594Impl create(
      ...
      final String containerName) {
    return new BlindedBeaconBlockBodySchemaEip7594Impl(
        containerName,
        ...
        namedSchema(
            ...
            new ExecutionPayloadHeaderSchemaEip7594(specConfig)),
        namedSchema(
  ...
  public SafeFuture<BeaconBlockBody> createBlockBody(
    ...
    final BeaconBlockBodyBuilderEip7594 builder = new BeaconBlockBodyBuilderEip7594(null, this);
    return bodyBuilder.apply(builder).thenApply(__ -> builder.build());
  }

  @Override
  public BlindedBeaconBlockBodyEip7594Impl createEmpty() {
    return new BlindedBeaconBlockBodyEip7594Impl(this);
  }
  ...
  @Override
  public BlindedBeaconBlockBodyEip7594Impl createFromBackingNode(final TreeNode node) {
    return new BlindedBeaconBlockBodyEip7594Impl(this, node);
  }

  @Override
  public ExecutionPayloadHeaderSchemaEip7594 getExecutionPayloadHeaderSchema() {
