...
public interface ReadOnlyStore extends TimeProvider {
  ...
  SafeFuture<Optional<SignedExecutionPayloadEnvelope>> retrieveExecutionPayloadEnvelope(
      Bytes32 blockRoot);
  ...
  SafeFuture<Optional<BeaconState>> retrieveExecutionPayloadState(Bytes32 blockRoot);
