...
public class LightClientUpdateSchemaElectra extends LightClientUpdateSchema {
    public LightClientUpdateSchemaElectra(final SpecConfigElectra specConfigElectra, final SchemaRegistry registry) {
        super(specConfigElectra, registry, NEXT_SYNC_COMMITTEE_GINDEX_ELECTRA, FINALIZED_ROOT_GINDEX_ELECTRA);
    }
}