...
public class ExecutionPayloadHeaderEip7594Impl
    extends Container17<
        ...
        SszUInt64,
        SszUInt64>
    implements ExecutionPayloadHeaderEip7594 {

  protected ExecutionPayloadHeaderEip7594Impl(
      ContainerSchema17<
              ExecutionPayloadHeaderEip7594Impl,
              SszBytes32,
              SszByteVector,
  ...
  public ExecutionPayloadHeaderEip7594Impl(
      ExecutionPayloadHeaderSchemaEip7594 schema,
  ...
  @Override
  public ExecutionPayloadHeaderSchemaEip7594 getSchema() {
    return (ExecutionPayloadHeaderSchemaEip7594) super.getSchema();
  }
