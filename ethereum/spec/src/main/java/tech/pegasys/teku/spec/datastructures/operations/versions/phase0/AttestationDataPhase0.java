...
public class AttestationDataPhase0
    extends Container5<
        AttestationDataPhase0, SszUInt64, SszUInt64, SszBytes32, Checkpoint, Checkpoint>
    implements AttestationData {

  AttestationDataPhase0(final AttestationDataPhase0Schema type, final TreeNode backingNode) {
    super(type, backingNode);
  }

  AttestationDataPhase0(
      final AttestationDataPhase0Schema schema,
      final UInt64 slot,
      final UInt64 index,
  ...
  @Override
  public AttestationDataPhase0Schema getSchema() {
    return (AttestationDataPhase0Schema) super.getSchema();
  }
}
