...
public class Constants {
  ...
  public static final Duration EL_BUILDER_STATUS_TIMEOUT = Duration.ofMillis(500);
  public static final Duration EL_BUILDER_REGISTER_VALIDATOR_TIMEOUT = Duration.ofSeconds(5);
  public static final Duration EL_BUILDER_GET_HEADER_TIMEOUT = Duration.ofSeconds(1);
  public static final Duration EL_BUILDER_GET_PAYLOAD_TIMEOUT = Duration.ofSeconds(1);
