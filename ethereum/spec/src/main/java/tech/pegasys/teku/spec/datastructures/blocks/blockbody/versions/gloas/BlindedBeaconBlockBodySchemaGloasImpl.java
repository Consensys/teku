...
public class BlindedBeaconBlockBodySchemaGloasImpl
    extends ContainerSchema12<
        BlindedBeaconBlockBodyGloasImpl,
        SszSignature,
        Eth1Data,
        SszBytes32,
  ...
  protected BlindedBeaconBlockBodySchemaGloasImpl(
  ...
  public static BlindedBeaconBlockBodySchemaGloasImpl create(
      final SpecConfigGloas specConfig,
      final String containerName,
      final SchemaRegistry schemaRegistry) {
    return new BlindedBeaconBlockBodySchemaGloasImpl(
        containerName,
  ...
  public SafeFuture<? extends BeaconBlockBody> createBlockBody(
    ...
    final BeaconBlockBodyBuilderGloas builder = new BeaconBlockBodyBuilderGloas(null, this);
    return bodyBuilder.apply(builder).thenApply(__ -> builder.build());
  }

  @Override
  public BlindedBeaconBlockBodyGloasImpl createEmpty() {
    return new BlindedBeaconBlockBodyGloasImpl(this);
  }
  ...
  @Override
  public BlindedBeaconBlockBodyGloasImpl createFromBackingNode(final TreeNode node) {
    return new BlindedBeaconBlockBodyGloasImpl(this, node);
  }
  ...
  @Override
  public Optional<BlindedBeaconBlockBodySchemaGloas<?>> toBlindedVersionGloas() {
