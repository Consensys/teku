...
public class VoteTrackerV1 implements VoteTracker {

  private final Bytes32 currentRoot;
  private final Bytes32 nextRoot;
  private final UInt64 nextEpoch;

  public VoteTrackerV1(Bytes32 currentRoot, Bytes32 nextRoot, UInt64 nextEpoch) {
  ...
  public boolean equals(Object o) {
    ...
    VoteTrackerV1 that = (VoteTrackerV1) o;
