...
public interface BlockContentsWithBlobsAndExecutionPayloadEnvelopeSchema<T extends BlockContainer>
  ...
  ExecutionPayloadEnvelopeSchema getExecutionPayloadEnvelopeSchema();
