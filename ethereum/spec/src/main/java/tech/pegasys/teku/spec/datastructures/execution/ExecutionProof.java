...
public class ExecutionProof
  ...
  private static final ExecutionProofSchema SSZ_SCHEMA = new ExecutionProofSchema();

  public ExecutionProof(final ExecutionProofSchema type, final TreeNode node) {
    super(type, node);
  }
