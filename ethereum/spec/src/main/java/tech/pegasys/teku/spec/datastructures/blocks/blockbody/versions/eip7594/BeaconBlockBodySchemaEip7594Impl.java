...
public class BeaconBlockBodySchemaEip7594Impl
    ...
    implements BeaconBlockBodySchemaEip7594<BeaconBlockBodyEip7594Impl> {
  ...
  protected BeaconBlockBodySchemaEip7594Impl(
      ...
      final NamedSchema<ExecutionPayloadEip7594Impl> executionPayloadSchema,
  ...
  public static BeaconBlockBodySchemaEip7594Impl create(
    ...
    return new BeaconBlockBodySchemaEip7594Impl(
        ...
        namedSchema(
            BlockBodyFields.EXECUTION_PAYLOAD, new ExecutionPayloadSchemaEip7594(specConfig)),
        namedSchema(
  ...
  public SafeFuture<? extends BeaconBlockBody> createBlockBody(
    ...
    final BeaconBlockBodyBuilderEip7594 builder = new BeaconBlockBodyBuilderEip7594(this, null);
  ...
  @Override
  public BeaconBlockBodyEip7594Impl createFromBackingNode(final TreeNode node) {
    return new BeaconBlockBodyEip7594Impl(this, node);
  }
