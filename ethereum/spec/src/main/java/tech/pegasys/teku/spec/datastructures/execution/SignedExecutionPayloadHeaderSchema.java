...
public class SignedExecutionPayloadHeaderSchema
  ...
  public SignedExecutionPayloadHeader create(
      final ExecutionPayloadHeader executionPayloadHeader, BLSSignature signature) {
    return new SignedExecutionPayloadHeader(this, executionPayloadHeader, signature);
  }
