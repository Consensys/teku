...
class BlindedBeaconBlockBodyEip7594Impl
    extends Container12<
    ...
    implements BlindedBeaconBlockBodyEip7594 {

  BlindedBeaconBlockBodyEip7594Impl(final BlindedBeaconBlockBodySchemaEip7594Impl type) {
    super(type);
  }

  BlindedBeaconBlockBodyEip7594Impl(
      final BlindedBeaconBlockBodySchemaEip7594Impl type, final TreeNode backingNode) {
    super(type, backingNode);
  }

  BlindedBeaconBlockBodyEip7594Impl(
      final BlindedBeaconBlockBodySchemaEip7594Impl type,
      ...
      final ExecutionPayloadHeaderEip7594Impl executionPayloadHeader,
  ...
  public static BlindedBeaconBlockBodyEip7594Impl required(final BeaconBlockBody body) {
    checkArgument(
        body instanceof BlindedBeaconBlockBodyEip7594Impl,
        "Expected EIP7594 blinded block body but got %s",
        body.getClass());
    return (BlindedBeaconBlockBodyEip7594Impl) body;
  }
  ...
  @Override
  public BlindedBeaconBlockBodySchemaEip7594Impl getSchema() {
    return (BlindedBeaconBlockBodySchemaEip7594Impl) super.getSchema();
  }
}
