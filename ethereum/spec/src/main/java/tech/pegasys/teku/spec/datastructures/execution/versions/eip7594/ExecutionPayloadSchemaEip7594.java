...
public class ExecutionPayloadSchemaEip7594
    extends ContainerSchema17<
        ...
        SszUInt64,
        SszUInt64>
    implements ExecutionPayloadSchema<ExecutionPayloadEip7594Impl> {

  private final ExecutionPayloadEip7594Impl defaultExecutionPayload;

  public ExecutionPayloadSchemaEip7594(final SpecConfigEip7594 specConfig) {
    super(
  ...
  @Override
  public ExecutionPayloadEip7594Impl getDefault() {
  ...
  public ExecutionPayload createExecutionPayload(
    ...
    final ExecutionPayloadBuilderEip7594 builder =
        new ExecutionPayloadBuilderEip7594().schema(this);
    builderConsumer.accept(builder);
    return builder.build();
  }

  @Override
  public ExecutionPayloadEip7594Impl createFromBackingNode(final TreeNode node) {
    return new ExecutionPayloadEip7594Impl(this, node);
  }
