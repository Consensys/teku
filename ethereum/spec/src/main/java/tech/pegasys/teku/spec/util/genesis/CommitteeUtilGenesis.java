...
package tech.pegasys.teku.spec.util.genesis;
...
public class CommitteeUtilGenesis implements CommitteeUtil {
  private final SpecConstants specConstants;

  public CommitteeUtilGenesis(final SpecConstants specConstants) {
