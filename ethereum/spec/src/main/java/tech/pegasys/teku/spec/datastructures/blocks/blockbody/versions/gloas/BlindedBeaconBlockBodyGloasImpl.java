...
public class BlindedBeaconBlockBodyGloasImpl
    extends Container12<
  ...
  BlindedBeaconBlockBodyGloasImpl(
      final BlindedBeaconBlockBodySchemaGloasImpl type,
  ...
  BlindedBeaconBlockBodyGloasImpl(final BlindedBeaconBlockBodySchemaGloasImpl type) {
    super(type);
  }

  BlindedBeaconBlockBodyGloasImpl(
      final BlindedBeaconBlockBodySchemaGloasImpl type, final TreeNode backingNode) {
    super(type, backingNode);
  }

  public static BlindedBeaconBlockBodyGloasImpl required(final BeaconBlockBody body) {
    checkArgument(
        body instanceof BlindedBeaconBlockBodyGloasImpl,
        "Expected Gloas blinded block body but got %s",
        body.getClass());
    return (BlindedBeaconBlockBodyGloasImpl) body;
  }
  ...
  @Override
  public BlindedBeaconBlockBodySchemaGloasImpl getSchema() {
    return (BlindedBeaconBlockBodySchemaGloasImpl) super.getSchema();
  }
}
