...
public class ExecutionPayloadHeaderSchemaElectra
  ...
  public ExecutionPayloadHeaderSchemaElectra(
      final SpecConfigElectra specConfig, final ExecutionWitnessSchema executionWitnessSchema) {
    super(
    ...
    final ExecutionPayloadElectraImpl defaultExecutionPayload =
        new ExecutionPayloadSchemaElectra(specConfig, executionWitnessSchema).getDefault();
  ...
  @Override
  public ExecutionPayloadHeaderElectraImpl createFromBackingNode(TreeNode node) {
