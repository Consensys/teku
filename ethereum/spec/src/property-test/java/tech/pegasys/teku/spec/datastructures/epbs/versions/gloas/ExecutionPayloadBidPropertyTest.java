...
public class ExecutionPayloadBidPropertyTest {
  @Property
  void roundTrip(
      @ForAll(supplier = ExecutionPayloadBidSupplier.class)
          final ExecutionPayloadBid executionPayloadBid)
      throws JsonProcessingException {
    assertRoundTrip(executionPayloadBid);
  }
  ...
  void deserializeMutated(
    ...
    assertDeserializeMutatedThrowsExpected(executionPayloadBid, seed);
  }
}
