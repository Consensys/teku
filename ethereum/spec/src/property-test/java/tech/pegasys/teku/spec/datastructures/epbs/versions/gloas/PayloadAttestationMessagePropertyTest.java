...
public class PayloadAttestationMessagePropertyTest {

  @Property
  void roundTrip(
      @ForAll(supplier = PayloadAttestationMessageSupplier.class)
          final PayloadAttestationMessage payloadAttestationMessage)
      throws JsonProcessingException {
    assertRoundTrip(payloadAttestationMessage);
  }
  ...
  void deserializeMutated(
    ...
    assertDeserializeMutatedThrowsExpected(payloadAttestationMessage, seed);
  }
}
