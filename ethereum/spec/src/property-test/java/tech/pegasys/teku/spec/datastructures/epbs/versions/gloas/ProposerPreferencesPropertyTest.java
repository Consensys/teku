...
public class ProposerPreferencesPropertyTest {

  @Property
  void roundTrip(
      @ForAll(supplier = ProposerPreferencesSupplier.class)
          final ProposerPreferences proposerPreferences)
      throws JsonProcessingException {
    assertRoundTrip(proposerPreferences);
  }
  ...
  void deserializeMutated(
    ...
    assertDeserializeMutatedThrowsExpected(proposerPreferences, seed);
  }
}
