...
public class SignedProposerPreferencesPropertyTest {

  @Property
  void roundTrip(
      @ForAll(supplier = SignedProposerPreferencesSupplier.class)
          final SignedProposerPreferences signedProposerPreferences)
      throws JsonProcessingException {
    assertRoundTrip(signedProposerPreferences);
  }
  ...
  void deserializeMutated(
    ...
    assertDeserializeMutatedThrowsExpected(signedProposerPreferences, seed);
  }
}
