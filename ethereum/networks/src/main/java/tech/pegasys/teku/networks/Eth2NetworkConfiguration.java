...
public class Eth2NetworkConfiguration {
  ...
  private static final ImmutableMap<String, NetworkDefinition> NETWORK_DEFINITIONS =
      ImmutableMap.<String, NetworkDefinition>builder()
          .put(MINIMAL, Eth2NetworkConfiguration::minimalNetworkBuilder)
          .put(MAINNET, Eth2NetworkConfiguration::mainnetBuilder)
          .put(MEDALLA, Eth2NetworkConfiguration::medallaBuilder)
          .put(TOLEDO, Eth2NetworkConfiguration::toledoBuilder)
          .put(PYRMONT, Eth2NetworkConfiguration::pyrmontBuilder)
          .build();
  ...
  public static Eth2NetworkConfiguration.Builder builder(final String network) {
    ...
    return NETWORK_DEFINITIONS
        .getOrDefault(normalizedNetwork, () -> builder().constants(normalizedNetwork))
        .get();
  }
  ...
  private static Eth2NetworkConfiguration.Builder minimalNetworkBuilder() {
    return builder().constants(MINIMAL).startupTargetPeerCount(0);
  }

  private static Eth2NetworkConfiguration.Builder mainnetBuilder() {
    return builder()
        .constants(MAINNET)
  ...
  private static Eth2NetworkConfiguration.Builder medallaBuilder() {
    return builder()
        .constants(MEDALLA)
  ...
  private static Eth2NetworkConfiguration.Builder toledoBuilder() {
    return builder()
        .constants(TOLEDO)
        .startupTimeoutSeconds(120)
  ...
  private static Eth2NetworkConfiguration.Builder pyrmontBuilder() {
    return builder()
        .constants(PYRMONT)
        .startupTimeoutSeconds(120)
  ...
  public static class Builder {
    ...
    // Add some getters to allow builder to be inspected
    public Optional<String> initialState() {
      return initialState;
    }

    public List<String> discoveryBootnodes() {
      return discoveryBootnodes;
    }

    public Optional<Eth1Address> eth1DepositContractAddress() {
      return eth1DepositContractAddress;
    }
  ...
  public interface NetworkDefinition {
    Eth2NetworkConfiguration.Builder get();
  }
}
