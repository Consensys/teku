...
public final class BeaconStateWithCache extends BeaconState {
  ...
  public BeaconStateWithCache(
    ...
    super(genesis_time,slot,fork,latest_block_header,block_roots,state_roots,historical_roots,eth1_data,eth1_data_votes,eth1_deposit_index,validators,balances,start_shard,randao_mixes,active_index_roots,compact_committees_roots,slashings,previous_epoch_attestations,current_epoch_attestations,previous_crosslinks,current_crosslinks,justification_bits,previous_justified_checkpoint,current_justified_chekpoint,finalized_checkpoint);
  }
