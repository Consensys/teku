...
class AttestationBitsCalculatorPhase0 implements AttestationBitsCalculator {
  private SszBitlist aggregationBits;

  AttestationBitsCalculatorPhase0(final SszBitlist aggregationBits) {
    this.aggregationBits = aggregationBits;
  }

  static AttestationBitsCalculator fromAttestationSchema(AttestationSchema<?> attestationSchema) {
    return new AttestationBitsCalculatorPhase0(attestationSchema.createEmptyAggregationBits());
  }
