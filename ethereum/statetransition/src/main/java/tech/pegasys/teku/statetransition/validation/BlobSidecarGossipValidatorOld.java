 ...
 */
@Deprecated
public class BlobSidecarGossipValidatorOld {
  ...
  public static BlobSidecarGossipValidatorOld create(
      final Spec spec,
      final Map<Bytes32, BlockImportResult> invalidBlockRoots,
    ...
    return new BlobSidecarGossipValidatorOld(
  ...
  private BlobSidecarGossipValidatorOld(
      final Spec spec,
      final Map<Bytes32, BlockImportResult> invalidBlockRoots,
