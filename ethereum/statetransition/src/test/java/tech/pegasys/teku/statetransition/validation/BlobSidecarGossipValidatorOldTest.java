...
import tech.pegasys.teku.statetransition.validation.BlobSidecarGossipValidatorOld.IndexAndBlockRoot;

@TestSpecContext(milestone = {SpecMilestone.DENEB})
public class BlobSidecarGossipValidatorOldTest {
  ...
  private BlobSidecarGossipValidatorOld blobSidecarValidator;
  ...
  void setUp(final SpecContext specContext) {
    ...
    blobSidecarValidator =
        BlobSidecarGossipValidatorOld.create(
  ...
  void shouldRejectWhenSlotIsNotDeneb() {
    ...
    blobSidecarValidator =
        BlobSidecarGossipValidatorOld.create(mockedSpec, invalidBlocks, gossipValidationHelper);
