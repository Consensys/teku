...
abstract class ForkChoiceTriggerTestBase {
  ...
  protected final ForkChoiceTrigger trigger;

  protected ForkChoiceTriggerTestBase(final boolean balanceAttackMitigationEnabled) {
    trigger = ForkChoiceTrigger.create(forkChoice, balanceAttackMitigationEnabled);
  }
  ...
  void requireForkChoiceCompleteForSlot_shouldBeCompleteWhenLastForkChoiceForLaterSlot() {
    ...
    final SafeFuture<Void> result = trigger.requireForkChoiceCompleteForSlot(UInt64.ONE);
