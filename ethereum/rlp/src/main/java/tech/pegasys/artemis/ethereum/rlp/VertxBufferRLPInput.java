...
public class VertxBufferRLPInput extends AbstractRLPInput {
     ...
     *
     * @return The total size of the encoded data that this input decodes (note that this value
     *     never changes, it is not the size of data remaining to decode, but the size to decode at
     *     creation time).
     */
