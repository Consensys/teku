...
public class BytesValueRLPOutputTest {
    ...
    public void singleBarelyLongElement() {
        ...
        // 56 bytes, so long element: 0xb7 + length of value size + value, where the value size is
        // 56.
    ...
    public void longScalar() {
        // Scalar should be encoded as the minimal byte array representing the number. For 0, that
        // means
