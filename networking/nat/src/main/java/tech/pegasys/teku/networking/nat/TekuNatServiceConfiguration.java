...
public class TekuNatServiceConfiguration implements UpnpServiceConfiguration {
  ...
  TekuNatServiceConfiguration() {
    this(
        NetworkAddressFactoryImpl.DEFAULT_TCP_HTTP_LISTEN_PORT,
        NetworkAddressFactoryImpl.DEFAULT_MULTICAST_RESPONSE_LISTEN_PORT);
  }

  public TekuNatServiceConfiguration(final int streamListenPort, final int multicastResponsePort) {
    executorService =
