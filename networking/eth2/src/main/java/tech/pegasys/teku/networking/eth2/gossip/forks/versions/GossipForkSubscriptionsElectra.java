...
import tech.pegasys.teku.networking.eth2.gossip.BlockAndInclusionListGossipManager;
...
public class GossipForkSubscriptionsElectra extends GossipForkSubscriptionsDeneb {
  ...
  public GossipForkSubscriptionsElectra(
    ...
    super(
        ...
        syncCommitteeMessageOperationProcessor,
        signedBlsToExecutionChangeOperationProcessor);
    this.blockAndInclusionListProcessor = blockAndInclusionListProcessor;
  }

  @Override
  void addBlockGossipManager(ForkInfo forkInfo) {
    final BlockAndInclusionListGossipManager blockAndInclusionListGossipManager =
        new BlockAndInclusionListGossipManager(
            recentChainData,
            spec,
            asyncRunner,
            discoveryNetwork,
            gossipEncoding,
            forkInfo,
            blockAndInclusionListProcessor);
    addGossipManager(blockAndInclusionListGossipManager);
  }
}
