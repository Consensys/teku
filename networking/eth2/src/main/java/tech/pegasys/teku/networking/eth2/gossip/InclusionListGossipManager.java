...
public class InclusionListGossipManager extends AbstractGossipManager<SignedInclusionList> {

  public InclusionListGossipManager(
      final Spec spec,
    ...
    super(
        ...
        networkingConfig,
        GossipFailureLogger.createSuppressing(GossipTopicName.INCLUSION_LIST.toString()),
        debugDataDumper);
  }

  public void publish(final SignedInclusionList message) {
