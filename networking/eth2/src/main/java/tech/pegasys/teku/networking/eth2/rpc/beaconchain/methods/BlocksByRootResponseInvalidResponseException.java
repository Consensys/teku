...
public class BlocksByRootResponseInvalidResponseException extends InvalidResponseException {

  public BlocksByRootResponseInvalidResponseException(
  ...
  public enum InvalidResponseType {
    BLOCK_UNEXPECTED_ROOT("Block root is not within requested roots");
