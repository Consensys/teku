...
import tech.pegasys.teku.networking.eth2.gossip.InclusionListGossipManager;
...
public class GossipForkSubscriptionsHeze extends GossipForkSubscriptionsGloas {

  private final OperationProcessor<SignedInclusionList> inclusionListProcessor;

  private InclusionListGossipManager inclusionListGossipManager;

  public GossipForkSubscriptionsHeze(
      final Fork fork,
      final Spec spec,
      ...
      final OperationProcessor<SignedInclusionList> inclusionListOperationProcessor,
    ...
    super(
        ...
        isSuperNodeSupplier);
    this.inclusionListProcessor = inclusionListOperationProcessor;
  }
  ...
  protected void addGossipManagers(final ForkInfo forkInfo, final Bytes4 forkDigest) {
    ...
    addInclusionListGossipManager(forkInfo, forkDigest);
  }

  void addInclusionListGossipManager(final ForkInfo forkInfo, final Bytes4 forkDigest) {
    this.inclusionListGossipManager =
        new InclusionListGossipManager(
            spec,
            recentChainData,
            asyncRunner,
            discoveryNetwork,
            ...
            debugDataDumper);
    addGossipManager(inclusionListGossipManager);
  }

  @Override
  public void publishSignedInclusionList(final SignedInclusionList message) {
    inclusionListGossipManager.publish(message);
  }
}
