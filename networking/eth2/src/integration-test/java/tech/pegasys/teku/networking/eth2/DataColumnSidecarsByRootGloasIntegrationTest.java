...
public class DataColumnSidecarsByRootGloasIntegrationTest
    extends DataColumnSidecarsByRootIntegrationTest {
  ...
  @Override
  protected DataColumnsByRootIdentifierSchema createDataColumnsIdentifierSchema(final Spec spec) {
