...
import tech.pegasys.artemis.networking.eth2.discovery.Eth2DiscoveryManager.State;
...
class Eth2DiscoveryManagerTest {
  ...
  void testNetworkUsage() throws Exception {
    ...
    //    doReturn(dmReal.getNodeTable()).when(dm).getNodeTable();
