...
public class GetOrGenerateFilePrivateKeySource implements PrivateKeySource {
  private final String fileName;

  public GetOrGenerateFilePrivateKeySource(final String fileName) {
  ...
  public boolean equals(final Object o) {
    ...
    GetOrGenerateFilePrivateKeySource that = (GetOrGenerateFilePrivateKeySource) o;
