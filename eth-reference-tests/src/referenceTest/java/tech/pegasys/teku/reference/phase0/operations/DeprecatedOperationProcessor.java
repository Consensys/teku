...
public class DeprecatedOperationProcessor implements OperationProcessor {
  ...
  public void processProposerSlashing(
      final MutableBeaconState state, final ProposerSlashing attesterSlashings)
      throws BlockProcessingException {
    BlockProcessorUtil.process_proposer_slashings(state, SSZList.singleton(attesterSlashings));
  }
