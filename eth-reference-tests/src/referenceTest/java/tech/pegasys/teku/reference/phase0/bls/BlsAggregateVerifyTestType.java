...
public class BlsAggregateVerifyTestType implements ThrowingConsumer<BlsTestData> {

  @Override
  public void accept(final BlsTestData blsTestData) throws Throwable {
    final List<BLSPublicKey> publicKeys = blsTestData.getPairsPublicKeys();
    final List<Bytes> messages = blsTestData.getPairsMessages();
