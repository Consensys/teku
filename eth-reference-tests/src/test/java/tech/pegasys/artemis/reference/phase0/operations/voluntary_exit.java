...
public class voluntary_exit extends TestSuite {
  @ParameterizedTest(
      name = "{index}. process VoluntaryExit voluntaryExit={0} bls_setting={1} -> pre={2} ")
  ...
  static Stream<Arguments> processVoluntaryExitInvalidSignatureSetup() throws Exception {
    ...
    Path path =
        Paths.get("/mainnet/phase0/operations/voluntary_exit/pyspec_tests/invalid_signature");
  ...
  @MethodSource({
    "processVoluntaryExitValidatorAlreadyExitedSetup",
    "processVoluntaryExitValidatorExitInFutureSetup",
    "processVoluntaryExitValidatorInvalidValidatorIndexSetup",
    "processVoluntaryExitValidatorNotActiveSetup",
    "processVoluntaryExitValidatorNotActiveLongEnoughSetup"
  })
  ...
  static Stream<Arguments> processVoluntaryExitValidatorAlreadyExitedSetup() throws Exception {
    ...
    Path path =
        Paths.get(
            "/mainnet/phase0/operations/voluntary_exit/pyspec_tests/validator_already_exited");
  ...
  static Stream<Arguments> processVoluntaryExitValidatorExitInFutureSetup() throws Exception {
    ...
    Path path =
        Paths.get(
            "/mainnet/phase0/operations/voluntary_exit/pyspec_tests/validator_exit_in_future");
    return operationVoluntaryExitType2Setup(path, configPath);
  }

  @MustBeClosed
  static Stream<Arguments> processVoluntaryExitValidatorInvalidValidatorIndexSetup()
      throws Exception {
    Path configPath = Paths.get("mainnet", "phase0");
    Path path =
        Paths.get(
            "/mainnet/phase0/operations/voluntary_exit/pyspec_tests/validator_invalid_validator_index");
    return operationVoluntaryExitType2Setup(path, configPath);
  }
  ...
  static Stream<Arguments> processVoluntaryExitValidatorNotActiveSetup() throws Exception {
    Path configPath = Paths.get("mainnet", "phase0");
    Path path =
        Paths.get("/mainnet/phase0/operations/voluntary_exit/pyspec_tests/validator_not_active");
    return operationVoluntaryExitType2Setup(path, configPath);
  }

  @MustBeClosed
  static Stream<Arguments> processVoluntaryExitValidatorNotActiveLongEnoughSetup()
      throws Exception {
    Path configPath = Paths.get("mainnet", "phase0");
    Path path =
        Paths.get(
            "/mainnet/phase0/operations/voluntary_exit/pyspec_tests/validator_not_active_long_enough");
    return operationVoluntaryExitType2Setup(path, configPath);
  }
  ...
  static Stream<Arguments> processVoluntarySuccessExitQueueSetup() throws Exception {
    Path configPath = Paths.get("mainnet", "phase0");
    Path path =
        Paths.get("/mainnet/phase0/operations/voluntary_exit/pyspec_tests/success_exit_queue");
    return operationVoluntaryExitType3Setup(path, configPath);
  }
}
