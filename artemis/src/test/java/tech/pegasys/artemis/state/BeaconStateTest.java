...
public class BeaconStateTest {
    ...
    //    AttestationData attestationData = new AttestationData(0, UInt64.MIN_VALUE, Hash.ZERO,
    // Hash.ZERO, Hash.ZERO,
    //        Hash.ZERO, UInt64.MIN_VALUE, Hash.ZERO);
    //    byte[] participation_bitfield = Bytes32.ZERO.extractArray();
    //
    //    BeaconState.get_attestation_participants(newState(), attestationData,
    ...
    //
    //    ArrayList<ShardCommittee> actual = BeaconState.get_attestation_participants(newState(),
    // attestationData,
    //        participation_bitfield);
    ...
    public void getAttestationParticipantsSuccessful() {
        ...
        shard_committee.add(
                new ShardCommittee(
                        UInt64.MIN_VALUE,
                        new ArrayList<>(Collections.nCopies(1, 0)),
                        UInt64.MIN_VALUE));
        ...
        ArrayList<ShardCommittee> actual =
                BeaconState.get_attestation_participants(
                        state, attestationData, participation_bitfield);

        assertThat(actual.get(1).getShard()).isEqualTo(UInt64.MIN_VALUE);
        assertThat(actual.get(1).getCommittee())
                .isEqualTo(new ArrayList<>(Collections.nCopies(1, 0)));
    ...
    public void deepCopyBeaconState() {
        ...
        assertThat(deepCopy.getPersistent_committees())
                .isNotEqualTo(state.getPersistent_committees());
