...
public final class Constants {
    ...
    public static final int LATEST_RANDAO_MIXES_LENGTH =
            (int) Math.pow(2, 13); // 8,192 randao mixes
    public static final UInt384[] EMPTY_SIGNATURE =
            new UInt384[] {UInt384.valueOf(0), UInt384.valueOf(0)};
