...
tmux new-session -d -s foo 'cd node_0 && ./artemis --config=./config/demoConfig.0.toml --logging=DEBUG'
tmux split-window -v -t 0 'cd node_1 && ./artemis --config=./config/demoConfig.1.toml --logging=DEBUG'
tmux split-window -h 'cd node_2 && ./artemis --config=./config/demoConfig.2.toml --logging=DEBUG'
tmux split-window -v -t 1 'cd node_3 && ./artemis --config=./config/demoConfig.3.toml --logging=DEBUG'
