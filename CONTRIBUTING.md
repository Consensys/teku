...
Welcome to the Artemis repository!  The following is a set of guidelines for contributing to this repo and its packages. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
This project and everyone participating in it is governed by the [Artemis Code of Conduct](CODE-OF-CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [private@pegasys.tech].
...
* **Perform a [cursory search of project issues](https://github.com/search?q=+is%3Aissue+repo%3APegasysEng/Artemis)** to see if the problem has already been reported. If it has **and the issue is still open**, add a comment to the existing issue instead of opening a new one.
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started Artemis, e.g. which command exactly you used in the terminal, or how you started it otherwise. 
...
* **Which version of the software are you using?** You can get the exact version by running `artemis -v` in your terminal.
...
* **What version of Java are you running?** You can get the exact version by looking at the artemis logfile during startup.
...
* **Specify which version of the software you're using.** You can get the exact version by running `artemis -v` in your terminal.
...
[search-label-windows]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Awindows
[search-label-linux]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Alinux
[search-label-mac]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Amac
[search-label-documentation]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Adocumentation
[search-label-performance]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Aperformance
[search-label-security]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Asecurity
[search-label-api]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Aapi

[search-label-enhancement]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Aenhancement
[search-label-bug]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Abug
[search-label-help-wanted]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Ahelp%20wanted
[search-label-good-first-issue]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Agood%20first%20issue
[search-label-info-needed]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Ainfo%20needed
[search-label-needs-reproduction]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Aneeds%20reproduction
[search-label-blocked]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Ablocked
[search-label-duplicate]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Aduplicate
[search-label-wontfix]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Awontfix
[search-label-invalid]: https://github.com/search?q=is%3Aopen+is%3Aissue+repo%3APegasysEng%2FArtemis+label%3Ainvalid
[search-label-work-in-progress]: https://github.com/search?q=is%3Aopen+is%3Apr+repo%3APegasysEng%2FArtemis+label%3Awork%20in%20progress
[search-label-requires-changes]: https://github.com/search?q=is%3Aopen+is%3Apr+repo%3APegasysEng%2FArtemis+label%3Arequires%20changes


[private@pegasys.tech]: mailto:private@pegasys.tech
[Gitter]: https://gitter.im/PegaSysEng/artemis
[Wiki]: https://github.com/PegaSysEng/artemis/wiki
[Debugging Wiki]: https://github.com/PegaSysEng/artemis/wiki/Debugging
[CLA.md]: /CLA.md
