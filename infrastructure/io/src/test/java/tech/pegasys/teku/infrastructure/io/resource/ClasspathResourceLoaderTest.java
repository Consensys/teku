...
class ClasspathResourceLoaderTest {
  ...
  public void shouldLoadAllowedResources() throws Exception {
    final ResourceLoader loader =
        new ClasspathResourceLoader(ClasspathResourceLoaderTest.class, __ -> true);
  ...
  public void shouldNotLoadDisallowedResources() throws Exception {
    final ResourceLoader loader =
        new ClasspathResourceLoader(ClasspathResourceLoaderTest.class, __ -> false);
  ...
  public void shouldLoadFirstAllowedAvailableResource() throws Exception {
    final ResourceLoader loader =
        new ClasspathResourceLoader(ClasspathResourceLoaderTest.class, s -> s.equals(TEST_FILE_2));
