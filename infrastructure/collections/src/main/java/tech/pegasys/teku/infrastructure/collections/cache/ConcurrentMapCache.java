 ...
 * locking on writes with minimal per-entry memory overhead. Ideal for caches that grow indefinitely
 * and never evict (e.g., validator public key lookups), where Caffeine's eviction bookkeeping would
 * be wasteful.
 *
