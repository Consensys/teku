...
public class Profile8<
  ...
  final ProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> schemaCache;

  protected Profile8(final ProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> schema) {
    super(schema);
    this.schemaCache = schema;
  }

  protected Profile8(
      final ProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> schema, final TreeNode backingNode) {
    super(schema, backingNode);
    this.schemaCache = schema;
  }

  protected Profile8(
      final ProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> schema,
      final V0 arg0,
      final V1 arg1,
      final V2 arg2,
      final V3 arg3,
