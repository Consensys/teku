...
public class Profile9<
  ...
  final ProfileSchema9<C, V0, V1, V2, V3, V4, V5, V6, V7, V8> schemaCache;

  protected Profile9(final ProfileSchema9<C, V0, V1, V2, V3, V4, V5, V6, V7, V8> schema) {
    super(schema);
    this.schemaCache = schema;
  }

  protected Profile9(
      final ProfileSchema9<C, V0, V1, V2, V3, V4, V5, V6, V7, V8> schema,
