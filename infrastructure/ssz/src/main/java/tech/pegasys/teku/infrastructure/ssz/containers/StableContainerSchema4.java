...
public abstract class StableContainerSchema4<
  ...
  public static <
          ...
          V2 extends SszData,
          V3 extends SszData>
      StableContainerSchema4<C, V0, V1, V2, V3> create(
          ...
          final BiFunction<StableContainerSchema4<C, V0, V1, V2, V3>, TreeNode, C> instanceCtor) {
    return new StableContainerSchema4<>(
  ...
  protected StableContainerSchema4(
      final SszSchema<V0> fieldSchema0,
      final SszSchema<V1> fieldSchema1,
      final SszSchema<V2> fieldSchema2,
      final SszSchema<V3> fieldSchema3,
