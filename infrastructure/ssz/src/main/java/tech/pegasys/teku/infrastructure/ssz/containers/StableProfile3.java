...
public class StableProfile3<
        C extends
            StableProfile3<C, V0, V1, V2>,
        V0 extends SszData, V1 extends SszData, V2 extends SszData>
    extends SszProfileImpl {

  protected StableProfile3(
      final StableProfileSchema3<
              C, V0, V1, V2>
          schema) {
    super(schema);
  }
  ...
  protected StableProfile3(
      final StableProfileSchema3<
              C, V0, V1, V2>
          schema, final V0 arg0, final V1 arg1, final V2 arg2) {
