...
public class StableProfile13<
        C extends StableProfile13<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12>,
        V0 extends SszData,
        V1 extends SszData,
        V2 extends SszData,
        V3 extends SszData,
  ...
  protected StableProfile13(
      final StableProfileSchema13<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12>
          schema) {
    super(schema);
  }

  protected StableProfile13(
      final StableProfileSchema13<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12> schema,
