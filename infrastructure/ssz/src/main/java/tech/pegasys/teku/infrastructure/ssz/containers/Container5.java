...
public class Container5<
        C extends
            Container5<C, V0, V1, V2, V3, V4>,
        V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData>
    extends AbstractSszImmutableContainer {

  protected Container5(
      final ContainerSchema5<C, V0, V1, V2, V3, V4>
          schema) {
    super(schema);
  }
  ...
  protected Container5(
      final ContainerSchema5<C, V0, V1, V2, V3, V4>
          schema, final V0 arg0, final V1 arg1, final V2 arg2, final V3 arg3, final V4 arg4) {
