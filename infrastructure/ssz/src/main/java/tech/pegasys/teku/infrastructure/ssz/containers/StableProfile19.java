...
public class StableProfile19<
  ...
  protected StableProfile19(
      final StableProfileSchema19<
              C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18>
          schema, final V0 arg0, final V1 arg1, final V2 arg2, final V3 arg3, final V4 arg4, final V5 arg5, final V6 arg6, final V7 arg7, final V8 arg8, final V9 arg9, final V10 arg10, final V11 arg11, final V12 arg12, final V13 arg13, final V14 arg14, final V15 arg15, final V16 arg16, final V17 arg17, final V18 arg18) {
    super(schema, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18);
  }
...
protected V15 getField15() {
    return getAny(getSchema().toProfileSchema().orElseThrow().getNthActiveFieldIndex(15));
  }

protected V16 getField16() {
    return getAny(getSchema().toProfileSchema().orElseThrow().getNthActiveFieldIndex(16));
  }

protected V17 getField17() {
    return getAny(getSchema().toProfileSchema().orElseThrow().getNthActiveFieldIndex(17));
  }

protected V18 getField18() {
    return getAny(getSchema().toProfileSchema().orElseThrow().getNthActiveFieldIndex(18));
  }
}
