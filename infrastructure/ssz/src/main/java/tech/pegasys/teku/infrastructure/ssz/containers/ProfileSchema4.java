...
public abstract class ProfileSchema4<
  ...
  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData>
      ProfileSchema4<C, V0, V1, V2, V3> create(
  ...
  protected ProfileSchema4(
    ...
    this(
        ...
        SszStableContainerSchema.createForProfileOnly(
            maxFieldCount, continuousActiveSchemas(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3)),
        IntStream.range(0, 4)
            .boxed()
  ...
  protected ProfileSchema4(
    ...
    assert activeFieldIndices.size() == 4;
  }
