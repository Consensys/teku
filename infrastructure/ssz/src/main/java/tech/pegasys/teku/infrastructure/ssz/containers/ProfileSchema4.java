...
public abstract class ProfileSchema4<
  ...
  public static <
      ...
      ProfileSchema4<C, V0, V1, V2, V3> create(
          ...
          final BiFunction<ProfileSchema4<C, V0, V1, V2, V3>, TreeNode, C> instanceCtor) {
    return new ProfileSchema4<>("", stableContainerSchema, activeFieldIndices) {
      @Override
  ...
  protected ProfileSchema4(
    ...
    this(
        ...
        SszStableContainerSchema.createForProfileOnly(
            maxFieldCount,
            continuousActiveSchemas(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3)),
        IntStream.range(0, 4).boxed().collect(Collectors.toUnmodifiableSet()));
  }
