...
public abstract class StableProfileSchema14<
        C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData, V10 extends SszData, V11 extends SszData, V12 extends SszData, V13 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData, V10 extends SszData, V11 extends SszData, V12 extends SszData, V13 extends SszData>
      StableProfileSchema14<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13>
          create(
              ...
              final BiFunction<
                      StableProfileSchema14<
                          C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13>,
                      TreeNode,
                      C>
                  instanceCtor) {
    return new StableProfileSchema14<>(
        fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, fieldSchema8, fieldSchema9, fieldSchema10, fieldSchema11, fieldSchema12, fieldSchema13, maxFieldCount) {
      @Override
  ...
  protected StableProfileSchema14(
    ...
    super(
        "",
        continuousActiveSchemas(List.of(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, fieldSchema8, fieldSchema9, fieldSchema10, fieldSchema11, fieldSchema12, fieldSchema13)),
        maxFieldCount);
  }
  ...
  protected StableProfileSchema14(
    ...
    super(
        ...
        continuousActiveNamedSchemas(
            List.of(fieldNamedSchema0, fieldNamedSchema1, fieldNamedSchema2, fieldNamedSchema3, fieldNamedSchema4, fieldNamedSchema5, fieldNamedSchema6, fieldNamedSchema7, fieldNamedSchema8, fieldNamedSchema9, fieldNamedSchema10, fieldNamedSchema11, fieldNamedSchema12, fieldNamedSchema13)),
        maxFieldCount);
  }
