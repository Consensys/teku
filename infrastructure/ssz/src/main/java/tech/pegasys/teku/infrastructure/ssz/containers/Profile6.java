...
public class Profile6<
  ...
  final ProfileSchema6<C, V0, V1, V2, V3, V4, V5> schemaCache;

  protected Profile6(final ProfileSchema6<C, V0, V1, V2, V3, V4, V5> schema) {
    super(schema);
    this.schemaCache = schema;
  }

  protected Profile6(
      final ProfileSchema6<C, V0, V1, V2, V3, V4, V5> schema, final TreeNode backingNode) {
    super(schema, backingNode);
    this.schemaCache = schema;
  }

  protected Profile6(
      final ProfileSchema6<C, V0, V1, V2, V3, V4, V5> schema,
      final V0 arg0,
      final V1 arg1,
      final V2 arg2,
      final V3 arg3,
