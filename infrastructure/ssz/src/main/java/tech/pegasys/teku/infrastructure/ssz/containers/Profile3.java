...
public class Profile3<
        C extends Profile3<C, V0, V1, V2>,
        V0 extends SszData,
        V1 extends SszData,
        V2 extends SszData>
    extends SszProfileImpl {
  final ProfileSchema3<C, V0, V1, V2> schemaCache;

  protected Profile3(final ProfileSchema3<C, V0, V1, V2> schema) {
    super(schema);
    this.schemaCache = schema;
  }

  protected Profile3(final ProfileSchema3<C, V0, V1, V2> schema, final TreeNode backingNode) {
    super(schema, backingNode);
    this.schemaCache = schema;
  }

  protected Profile3(
      final ProfileSchema3<C, V0, V1, V2> schema, final V0 arg0, final V1 arg1, final V2 arg2) {
