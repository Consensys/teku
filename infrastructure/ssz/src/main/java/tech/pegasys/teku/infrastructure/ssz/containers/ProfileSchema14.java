...
public abstract class ProfileSchema14<
  ...
  public static <
      ...
      ProfileSchema14<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13> create(
          ...
          final BiFunction<
                  ProfileSchema14<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13>,
                  TreeNode,
                  C>
              instanceCtor) {
    return new ProfileSchema14<>("", stableContainerSchema, activeFieldIndices) {
      @Override
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            ...
            List.of(
                ...
                fieldSchema12,
                fieldSchema13)),
        IntStream.range(0, 14).boxed().collect(Collectors.toUnmodifiableSet()));
  }
