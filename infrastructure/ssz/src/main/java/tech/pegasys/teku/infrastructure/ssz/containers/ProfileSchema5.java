...
public abstract class ProfileSchema5<
  ...
  public static <
      ...
      ProfileSchema5<C, V0, V1, V2, V3, V4> create(
          ...
          final BiFunction<ProfileSchema5<C, V0, V1, V2, V3, V4>, TreeNode, C> instanceCtor) {
    return new ProfileSchema5<>("", stableContainerSchema, activeFieldIndices) {
      @Override
  ...
  protected ProfileSchema5(
    ...
    this(
        ...
        IntStream.range(0, 5).boxed().collect(Collectors.toUnmodifiableSet()));
  }
