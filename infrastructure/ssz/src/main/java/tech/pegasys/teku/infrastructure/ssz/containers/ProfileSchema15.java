...
public abstract class ProfileSchema15<
  ...
  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData, V10 extends SszData, V11 extends SszData, V12 extends SszData, V13 extends SszData, V14 extends SszData>
      ProfileSchema15<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14> create(
  ...
  protected ProfileSchema15(
    ...
    this(
        ...
        SszStableContainerSchema.createForProfileOnly(
            maxFieldCount, continuousActiveSchemas(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, fieldSchema8, fieldSchema9, fieldSchema10, fieldSchema11, fieldSchema12, fieldSchema13, fieldSchema14)),
  ...
  protected ProfileSchema15(
    ...
    assert activeFieldIndices.size() == 15;
  }
