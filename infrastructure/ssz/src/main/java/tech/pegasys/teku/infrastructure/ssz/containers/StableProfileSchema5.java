...
public abstract class StableProfileSchema5<
  ...
  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData>
      StableProfileSchema5<C, V0, V1, V2, V3, V4>
          create(
  ...
  protected StableProfileSchema5(
    ...
    super(
        "",
        continuousActiveSchemas(List.of(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4)),
        maxFieldCount);
  }
  ...
  protected StableProfileSchema5(
    ...
    super(
        containerName,
        List.of(fieldNamedIndexedSchema0, fieldNamedIndexedSchema1, fieldNamedIndexedSchema2, fieldNamedIndexedSchema3, fieldNamedIndexedSchema4),
        maxFieldCount);
  }
