...
public abstract class ProfileSchema20<
      ...
      ProfileSchema20<
          ...
          create(
              ...
              final BiFunction<
                      ...
                      C>
                  instanceCtor) {
    return new ProfileSchema20<>("", stableContainerSchema, activeFieldIndices) {
      @Override
  ...
  protected ProfileSchema20(
    ...
    assert activeFieldIndices.size() == 20;
  ...
  public SszSchema<V19> getFieldSchema19() {
    return (SszSchema<V19>) getChildSchema(indexMapping[19]);
  }
}
