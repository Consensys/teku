...
public abstract class StableProfileSchema8<
        C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData>
      StableProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7>
          create(
              final SszSchema<V0> fieldSchema0, final SszSchema<V1> fieldSchema1, final SszSchema<V2> fieldSchema2, final SszSchema<V3> fieldSchema3, final SszSchema<V4> fieldSchema4, final SszSchema<V5> fieldSchema5, final SszSchema<V6> fieldSchema6, final SszSchema<V7> fieldSchema7,
              final int maxFieldCount,
              final BiFunction<
                      StableProfileSchema8<
                          C, V0, V1, V2, V3, V4, V5, V6, V7>,
                      TreeNode,
                      C>
                  instanceCtor) {
    return new StableProfileSchema8<>(
        fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, maxFieldCount) {
      @Override
  ...
  protected StableProfileSchema8(
    ...
    super(
        "",
        continuousActiveSchemas(List.of(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7)),
        maxFieldCount);
  }

  protected StableProfileSchema8(
      final String containerName,
      final NamedSchema<V0> fieldNamedSchema0, final NamedSchema<V1> fieldNamedSchema1, final NamedSchema<V2> fieldNamedSchema2, final NamedSchema<V3> fieldNamedSchema3, final NamedSchema<V4> fieldNamedSchema4, final NamedSchema<V5> fieldNamedSchema5, final NamedSchema<V6> fieldNamedSchema6, final NamedSchema<V7> fieldNamedSchema7,
      final int maxFieldCount) {

    super(
        containerName,
        continuousActiveNamedSchemas(
            List.of(fieldNamedSchema0, fieldNamedSchema1, fieldNamedSchema2, fieldNamedSchema3, fieldNamedSchema4, fieldNamedSchema5, fieldNamedSchema6, fieldNamedSchema7)),
        maxFieldCount);
  }
  ...
  protected StableProfileSchema8(
    ...
    super(
        containerName,
        List.of(fieldNamedIndexedSchema0, fieldNamedIndexedSchema1, fieldNamedIndexedSchema2, fieldNamedIndexedSchema3, fieldNamedIndexedSchema4, fieldNamedIndexedSchema5, fieldNamedIndexedSchema6, fieldNamedIndexedSchema7),
        maxFieldCount);
  }
