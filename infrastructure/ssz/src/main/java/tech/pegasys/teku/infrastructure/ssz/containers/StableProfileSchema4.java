...
public abstract class StableProfileSchema4<
        C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData>
      StableProfileSchema4<C, V0, V1, V2, V3>
          create(
              final SszSchema<V0> fieldSchema0, final SszSchema<V1> fieldSchema1, final SszSchema<V2> fieldSchema2, final SszSchema<V3> fieldSchema3,
              final int maxFieldCount,
              final BiFunction<
                      StableProfileSchema4<
                          C, V0, V1, V2, V3>,
                      TreeNode,
                      C>
                  instanceCtor) {
  ...
  protected StableProfileSchema4(
      ...
      final NamedSchema<V0> fieldNamedSchema0, final NamedSchema<V1> fieldNamedSchema1, final NamedSchema<V2> fieldNamedSchema2, final NamedSchema<V3> fieldNamedSchema3,
      final int maxFieldCount) {
  ...
  protected StableProfileSchema4(
      final String containerName,
      final NamedIndexedSchema<V0> fieldNamedIndexedSchema0, final NamedIndexedSchema<V1> fieldNamedIndexedSchema1, final NamedIndexedSchema<V2> fieldNamedIndexedSchema2, final NamedIndexedSchema<V3> fieldNamedIndexedSchema3,
      final int maxFieldCount) {

    super(
        containerName,
        List.of(fieldNamedIndexedSchema0, fieldNamedIndexedSchema1, fieldNamedIndexedSchema2, fieldNamedIndexedSchema3),
        maxFieldCount);
  }
