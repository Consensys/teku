...
public abstract class ProfileSchema2<C extends SszProfile, V0 extends SszData, V1 extends SszData>
    extends AbstractSszProfileSchema<C> {

  private final int[] indexMapping;

  public static <C extends SszProfile, V0 extends SszData, V1 extends SszData>
      ProfileSchema2<C, V0, V1> create(
          final SszStableContainerSchema<? extends SszStableContainer> stableContainerSchema,
          final Set<Integer> activeFieldIndices,
          final BiFunction<ProfileSchema2<C, V0, V1>, TreeNode, C> instanceCtor) {
    return new ProfileSchema2<>("", stableContainerSchema, activeFieldIndices) {
      @Override
  ...
  protected ProfileSchema2(
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            maxFieldCount, List.of(fieldSchema0, fieldSchema1)),
        IntStream.range(0, 2).boxed().collect(Collectors.toUnmodifiableSet()));
  }
  ...
  protected ProfileSchema2(
    ...
    this(
        ...
        SszStableContainerSchema.createFromNamedSchemasForProfileOnly(
            maxFieldCount, List.of(fieldNamedSchema0, fieldNamedSchema1)),
        IntStream.range(0, 2).boxed().collect(Collectors.toUnmodifiableSet()));
  }
  ...
  protected ProfileSchema2(
    ...
    assert activeFieldIndices.size() == 2;
