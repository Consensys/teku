...
public abstract class ProfileSchema10<
  ...
  public static <
      ...
      ProfileSchema10<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9> create(
          ...
          final BiFunction<ProfileSchema10<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9>, TreeNode, C>
              instanceCtor) {
    return new ProfileSchema10<>("", stableContainerSchema, activeFieldIndices) {
      @Override
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            ...
            List.of(
                ...
                fieldSchema8,
                fieldSchema9)),
        IntStream.range(0, 10).boxed().collect(Collectors.toUnmodifiableSet()));
  }
