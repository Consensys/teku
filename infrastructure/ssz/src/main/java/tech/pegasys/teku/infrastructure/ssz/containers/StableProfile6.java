...
public class StableProfile6<
        C extends StableProfile6<C, V0, V1, V2, V3, V4, V5>,
        V0 extends SszData,
        V1 extends SszData,
        V2 extends SszData,
        V3 extends SszData,
  ...
  protected StableProfile6(final StableProfileSchema6<C, V0, V1, V2, V3, V4, V5> schema) {
    super(schema);
  }

  protected StableProfile6(
      final StableProfileSchema6<C, V0, V1, V2, V3, V4, V5> schema, final TreeNode backingNode) {
    super(schema, backingNode);
  }

  protected StableProfile6(
      final StableProfileSchema6<C, V0, V1, V2, V3, V4, V5> schema,
      final V0 arg0,
      final V1 arg1,
      final V2 arg2,
      final V3 arg3,
