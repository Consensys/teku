...
public class StableProfile6<
        C extends
            StableProfile6<C, V0, V1, V2, V3, V4, V5>,
        V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData>
    extends SszProfileImpl {

  protected StableProfile6(
      final StableProfileSchema6<
              C, V0, V1, V2, V3, V4, V5>
          schema) {
    super(schema);
  }
  ...
  protected StableProfile6(
      final StableProfileSchema6<
              C, V0, V1, V2, V3, V4, V5>
          schema, final V0 arg0, final V1 arg1, final V2 arg2, final V3 arg3, final V4 arg4, final V5 arg5) {
    super(schema, arg0, arg1, arg2, arg3, arg4, arg5);
  }
