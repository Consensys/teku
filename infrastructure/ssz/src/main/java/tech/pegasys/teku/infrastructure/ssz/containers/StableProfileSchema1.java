...
public abstract class StableProfileSchema1<
        C extends SszProfile, V0 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <
          C extends SszProfile, V0 extends SszData>
      StableProfileSchema1<C, V0>
          create(
              final SszSchema<V0> fieldSchema0,
              final int maxFieldCount,
              final BiFunction<
                      StableProfileSchema1<
                          C, V0>,
                      TreeNode,
                      C>
                  instanceCtor) {
    return new StableProfileSchema1<>(
        fieldSchema0, maxFieldCount) {
      @Override
  ...
  protected StableProfileSchema1(
    ...
    super(
        "",
        continuousActiveSchemas(List.of(fieldSchema0)),
        maxFieldCount);
  }
  ...
  protected StableProfileSchema1(
    ...
    super(
        containerName,
        List.of(fieldNamedIndexedSchema0),
        maxFieldCount);
  }
