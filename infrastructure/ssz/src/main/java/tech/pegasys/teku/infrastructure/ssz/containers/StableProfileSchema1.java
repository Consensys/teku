...
public abstract class StableProfileSchema1<C extends SszProfile, V0 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <C extends SszProfile, V0 extends SszData> StableProfileSchema1<C, V0> create(
