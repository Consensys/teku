...
public abstract class ProfileSchema8<
  ...
  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData>
      ProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> create(
  ...
  protected ProfileSchema8(
    ...
    this(
        ...
        SszStableContainerSchema.createForProfileOnly(
            maxFieldCount, continuousActiveSchemas(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7)),
        IntStream.range(0, 8)
            .boxed()
  ...
  protected ProfileSchema8(
    ...
    assert activeFieldIndices.size() == 8;
  }
