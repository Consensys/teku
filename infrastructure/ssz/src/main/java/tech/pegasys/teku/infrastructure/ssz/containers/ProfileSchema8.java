...
public abstract class ProfileSchema8<
  ...
  public static <
      ...
      ProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> create(
          ...
          final BiFunction<ProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7>, TreeNode, C>
              instanceCtor) {
    return new ProfileSchema8<>("", stableContainerSchema, activeFieldIndices) {
      @Override
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            ...
            List.of(
                ...
                fieldSchema6,
                fieldSchema7)),
        IntStream.range(0, 8).boxed().collect(Collectors.toUnmodifiableSet()));
  }
