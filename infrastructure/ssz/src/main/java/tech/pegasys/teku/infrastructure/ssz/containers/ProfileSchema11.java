...
public abstract class ProfileSchema11<
  ...
  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData, V10 extends SszData>
      ProfileSchema11<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10> create(
  ...
  protected ProfileSchema11(
    ...
    this(
        ...
        SszStableContainerSchema.createForProfileOnly(
            maxFieldCount, continuousActiveSchemas(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, fieldSchema8, fieldSchema9, fieldSchema10)),
  ...
  protected ProfileSchema11(
    ...
    assert activeFieldIndices.size() == 11;
  }
