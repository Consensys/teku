...
public abstract class ProfileSchema11<
  ...
  public static <
      ...
      ProfileSchema11<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10> create(
          ...
          final BiFunction<
                  ProfileSchema11<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10>, TreeNode, C>
              instanceCtor) {
    return new ProfileSchema11<>("", stableContainerSchema, activeFieldIndices) {
      @Override
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            ...
            List.of(
                ...
                fieldSchema9,
                fieldSchema10)),
        IntStream.range(0, 11).boxed().collect(Collectors.toUnmodifiableSet()));
  }
