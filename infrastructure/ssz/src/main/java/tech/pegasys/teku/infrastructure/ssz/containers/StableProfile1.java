...
public class StableProfile1<C extends StableProfile1<C, V0>, V0 extends SszData>
  ...
  protected StableProfile1(final ContainerSchema1<C, V0> schema) {
    super(schema);
  }

  protected StableProfile1(final ContainerSchema1<C, V0> schema, final TreeNode backingNode) {
    super(schema, backingNode);
  }

  protected StableProfile1(final ContainerSchema1<C, V0> schema, final V0 arg0) {
    super(schema, arg0);
  }
