...
public abstract class ProfileSchema17<
  ...
  public static <
          ...
          V15 extends SszData,
          V16 extends SszData>
      ProfileSchema17<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16>
          create(
              ...
              final BiFunction<
                      ...
                      C>
                  instanceCtor) {
    return new ProfileSchema17<>("", stableContainerSchema, activeFieldIndices) {
      @Override
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            ...
            List.of(
                ...
                fieldSchema15,
                fieldSchema16)),
        IntStream.range(0, 17).boxed().collect(Collectors.toUnmodifiableSet()));
  }
