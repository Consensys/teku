...
public abstract class StableProfileSchema10<
        C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData>
      StableProfileSchema10<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9>
          create(
              final SszSchema<V0> fieldSchema0, final SszSchema<V1> fieldSchema1, final SszSchema<V2> fieldSchema2, final SszSchema<V3> fieldSchema3, final SszSchema<V4> fieldSchema4, final SszSchema<V5> fieldSchema5, final SszSchema<V6> fieldSchema6, final SszSchema<V7> fieldSchema7, final SszSchema<V8> fieldSchema8, final SszSchema<V9> fieldSchema9,
              final int maxFieldCount,
              final BiFunction<
                      StableProfileSchema10<
                          C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9>,
                      TreeNode,
                      C>
                  instanceCtor) {
    return new StableProfileSchema10<>(
        fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, fieldSchema8, fieldSchema9, maxFieldCount) {
      @Override
  ...
  protected StableProfileSchema10(
      final SszSchema<V0> fieldSchema0, final SszSchema<V1> fieldSchema1, final SszSchema<V2> fieldSchema2, final SszSchema<V3> fieldSchema3, final SszSchema<V4> fieldSchema4, final SszSchema<V5> fieldSchema5, final SszSchema<V6> fieldSchema6, final SszSchema<V7> fieldSchema7, final SszSchema<V8> fieldSchema8, final SszSchema<V9> fieldSchema9,
      final int maxFieldCount) {

    super(
        "",
        continuousActiveSchemas(List.of(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, fieldSchema8, fieldSchema9)),
        maxFieldCount);
  }
  ...
  protected StableProfileSchema10(
    ...
    super(
        ...
        continuousActiveNamedSchemas(
            List.of(fieldNamedSchema0, fieldNamedSchema1, fieldNamedSchema2, fieldNamedSchema3, fieldNamedSchema4, fieldNamedSchema5, fieldNamedSchema6, fieldNamedSchema7, fieldNamedSchema8, fieldNamedSchema9)),
        maxFieldCount);
  }

  protected StableProfileSchema10(
      final String containerName,
      final NamedIndexedSchema<V0> fieldNamedIndexedSchema0, final NamedIndexedSchema<V1> fieldNamedIndexedSchema1, final NamedIndexedSchema<V2> fieldNamedIndexedSchema2, final NamedIndexedSchema<V3> fieldNamedIndexedSchema3, final NamedIndexedSchema<V4> fieldNamedIndexedSchema4, final NamedIndexedSchema<V5> fieldNamedIndexedSchema5, final NamedIndexedSchema<V6> fieldNamedIndexedSchema6, final NamedIndexedSchema<V7> fieldNamedIndexedSchema7, final NamedIndexedSchema<V8> fieldNamedIndexedSchema8, final NamedIndexedSchema<V9> fieldNamedIndexedSchema9,
      final int maxFieldCount) {

    super(
        containerName,
        List.of(fieldNamedIndexedSchema0, fieldNamedIndexedSchema1, fieldNamedIndexedSchema2, fieldNamedIndexedSchema3, fieldNamedIndexedSchema4, fieldNamedIndexedSchema5, fieldNamedIndexedSchema6, fieldNamedIndexedSchema7, fieldNamedIndexedSchema8, fieldNamedIndexedSchema9),
        maxFieldCount);
  }
