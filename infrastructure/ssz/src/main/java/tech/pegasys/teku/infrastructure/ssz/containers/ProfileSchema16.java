...
public abstract class ProfileSchema16<
  ...
  public static <
          ...
          V14 extends SszData,
          V15 extends SszData>
      ProfileSchema16<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15>
          create(
              ...
              final BiFunction<
                      ...
                      C>
                  instanceCtor) {
    return new ProfileSchema16<>("", stableContainerSchema, activeFieldIndices) {
      @Override
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            ...
            List.of(
                ...
                fieldSchema14,
                fieldSchema15)),
        IntStream.range(0, 16).boxed().collect(Collectors.toUnmodifiableSet()));
  }
