...
public abstract class ProfileSchema19<
  ...
  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData, V10 extends SszData, V11 extends SszData, V12 extends SszData, V13 extends SszData, V14 extends SszData, V15 extends SszData, V16 extends SszData, V17 extends SszData, V18 extends SszData>
      ProfileSchema19<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17, V18> create(
  ...
  protected ProfileSchema19(
    ...
    this(
        ...
        SszStableContainerSchema.createForProfileOnly(
            maxFieldCount, continuousActiveSchemas(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, fieldSchema6, fieldSchema7, fieldSchema8, fieldSchema9, fieldSchema10, fieldSchema11, fieldSchema12, fieldSchema13, fieldSchema14, fieldSchema15, fieldSchema16, fieldSchema17, fieldSchema18)),
  ...
  public SszSchema<V13> getFieldSchema13() {
    return (SszSchema<V13>) getNthActiveFieldSchema(13);
  }


  @SuppressWarnings("unchecked")
  public SszSchema<V14> getFieldSchema14() {
    return (SszSchema<V14>) getNthActiveFieldSchema(14);
  }


  @SuppressWarnings("unchecked")
  public SszSchema<V15> getFieldSchema15() {
    return (SszSchema<V15>) getNthActiveFieldSchema(15);
  }


  @SuppressWarnings("unchecked")
  public SszSchema<V16> getFieldSchema16() {
    return (SszSchema<V16>) getNthActiveFieldSchema(16);
  }


  @SuppressWarnings("unchecked")
  public SszSchema<V17> getFieldSchema17() {
    return (SszSchema<V17>) getNthActiveFieldSchema(17);
  }


  @SuppressWarnings("unchecked")
  public SszSchema<V18> getFieldSchema18() {
    return (SszSchema<V18>) getNthActiveFieldSchema(18);
  }
