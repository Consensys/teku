...
public class StableProfile4<
        C extends StableProfile4<C, V0, V1, V2, V3>,
        V0 extends SszData,
        V1 extends SszData,
        V2 extends SszData,
        V3 extends SszData>
  ...
  protected StableProfile4(final StableProfileSchema4<C, V0, V1, V2, V3> schema) {
    super(schema);
  }

  protected StableProfile4(
      final StableProfileSchema4<C, V0, V1, V2, V3> schema, final TreeNode backingNode) {
    super(schema, backingNode);
  }

  protected StableProfile4(
      final StableProfileSchema4<C, V0, V1, V2, V3> schema,
      final V0 arg0,
      final V1 arg1,
      final V2 arg2,
      final V3 arg3) {
    super(schema, arg0, arg1, arg2, arg3);
  }
