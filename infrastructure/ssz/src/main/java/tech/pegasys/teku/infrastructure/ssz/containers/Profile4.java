...
public class Profile4<
        C extends Profile4<C, V0, V1, V2, V3>,
        V0 extends SszData,
        V1 extends SszData,
        V2 extends SszData,
        V3 extends SszData>
    extends SszProfileImpl {
  final ProfileSchema4<C, V0, V1, V2, V3> schemaCache;

  protected Profile4(final ProfileSchema4<C, V0, V1, V2, V3> schema) {
    super(schema);
    this.schemaCache = schema;
  }

  protected Profile4(final ProfileSchema4<C, V0, V1, V2, V3> schema, final TreeNode backingNode) {
    super(schema, backingNode);
    this.schemaCache = schema;
  }

  protected Profile4(
      final ProfileSchema4<C, V0, V1, V2, V3> schema,
      final V0 arg0,
      final V1 arg1,
      final V2 arg2,
      final V3 arg3) {
