...
public class Profile10<
  ...
  final ProfileSchema10<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9> schemaCache;

  protected Profile10(final ProfileSchema10<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9> schema) {
    super(schema);
    this.schemaCache = schema;
  }

  protected Profile10(
      final ProfileSchema10<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9> schema,
