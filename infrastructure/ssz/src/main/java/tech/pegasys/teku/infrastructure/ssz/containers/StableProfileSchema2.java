...
public abstract class StableProfileSchema2<
        C extends SszStableContainer, V0 extends SszData, V1 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <C extends SszStableContainer, V0 extends SszData, V1 extends SszData>
