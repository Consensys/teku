...
public class StableProfile8<
        C extends
            StableProfile8<C, V0, V1, V2, V3, V4, V5, V6, V7>,
        V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData>
    extends SszProfileImpl {

  protected StableProfile8(
      final StableProfileSchema8<
  ...
  protected StableProfile8(
      final StableProfileSchema8<
              C, V0, V1, V2, V3, V4, V5, V6, V7>
          schema, final V0 arg0, final V1 arg1, final V2 arg2, final V3 arg3, final V4 arg4, final V5 arg5, final V6 arg6, final V7 arg7) {
