...
public class StableProfile8<
        C extends StableProfile8<C, V0, V1, V2, V3, V4, V5, V6, V7>,
        V0 extends SszData,
        V1 extends SszData,
        V2 extends SszData,
        V3 extends SszData,
  ...
  protected StableProfile8(final StableProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> schema) {
    super(schema);
  }

  protected StableProfile8(
      final StableProfileSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> schema,
