...
public class StableProfile12<
        C extends
            StableProfile12<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11>,
        V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData, V6 extends SszData, V7 extends SszData, V8 extends SszData, V9 extends SszData, V10 extends SszData, V11 extends SszData>
    extends SszProfileImpl {

  protected StableProfile12(
      final StableProfileSchema12<
  ...
  protected StableProfile12(
      final StableProfileSchema12<
              C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11>
          schema, final V0 arg0, final V1 arg1, final V2 arg2, final V3 arg3, final V4 arg4, final V5 arg5, final V6 arg6, final V7 arg7, final V8 arg8, final V9 arg9, final V10 arg10, final V11 arg11) {
