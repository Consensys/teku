...
public abstract class StableProfileSchema6<
        C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData>
    extends AbstractSszStableProfileSchema<C> {

  public static <
          C extends SszProfile, V0 extends SszData, V1 extends SszData, V2 extends SszData, V3 extends SszData, V4 extends SszData, V5 extends SszData>
      StableProfileSchema6<C, V0, V1, V2, V3, V4, V5>
          create(
              ...
              final BiFunction<
                      StableProfileSchema6<
                          C, V0, V1, V2, V3, V4, V5>,
                      TreeNode,
                      C>
                  instanceCtor) {
    return new StableProfileSchema6<>(
        fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5, maxFieldCount) {
      @Override
  ...
  protected StableProfileSchema6(
      final SszSchema<V0> fieldSchema0, final SszSchema<V1> fieldSchema1, final SszSchema<V2> fieldSchema2, final SszSchema<V3> fieldSchema3, final SszSchema<V4> fieldSchema4, final SszSchema<V5> fieldSchema5,
      final int maxFieldCount) {

    super(
        "",
        continuousActiveSchemas(List.of(fieldSchema0, fieldSchema1, fieldSchema2, fieldSchema3, fieldSchema4, fieldSchema5)),
        maxFieldCount);
  }
  ...
  protected StableProfileSchema6(
    ...
    super(
        ...
        continuousActiveNamedSchemas(
            List.of(fieldNamedSchema0, fieldNamedSchema1, fieldNamedSchema2, fieldNamedSchema3, fieldNamedSchema4, fieldNamedSchema5)),
        maxFieldCount);
  }
  ...
  protected StableProfileSchema6(
    ...
    super(
        containerName,
        List.of(fieldNamedIndexedSchema0, fieldNamedIndexedSchema1, fieldNamedIndexedSchema2, fieldNamedIndexedSchema3, fieldNamedIndexedSchema4, fieldNamedIndexedSchema5),
        maxFieldCount);
  }
