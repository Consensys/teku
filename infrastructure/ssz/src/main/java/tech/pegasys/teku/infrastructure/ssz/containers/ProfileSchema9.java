...
public abstract class ProfileSchema9<
  ...
  public static <
      ...
      ProfileSchema9<C, V0, V1, V2, V3, V4, V5, V6, V7, V8> create(
          ...
          final BiFunction<ProfileSchema9<C, V0, V1, V2, V3, V4, V5, V6, V7, V8>, TreeNode, C>
              instanceCtor) {
    return new ProfileSchema9<>("", stableContainerSchema, activeFieldIndices) {
      @Override
    ...
    this(
        ...
        SszStableContainerSchema.createFromSchemasForProfileOnly(
            ...
            List.of(
                ...
                fieldSchema7,
                fieldSchema8)),
        IntStream.range(0, 9).boxed().collect(Collectors.toUnmodifiableSet()));
  }
