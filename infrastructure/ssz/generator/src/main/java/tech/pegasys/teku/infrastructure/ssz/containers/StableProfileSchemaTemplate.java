...
public abstract class /*$$TypeClassName*/ StableProfileSchemaTemplate /*$$*/<
        C extends SszStableContainer, /*$$ViewTypes*/ V0 extends SszData, V1 extends SszData /*$$*/>
    extends AbstractSszStableProfileSchema<C> {

  public static <
          C extends SszStableContainer, /*$$ViewTypes*/
          V0 extends SszData,
          V1 extends SszData /*$$*/>
      /*$$TypeClassName*/ StableProfileSchemaTemplate /*$$*/<C, /*$$ViewTypeNames*/ V0, V1 /*$$*/>
          create(
              /*$$FieldsDeclarations*/
              ...
              final BiFunction<
                      /*$$TypeClassName*/ StableProfileSchemaTemplate /*$$*/<
                          C, /*$$ViewTypeNames*/ V0, V1 /*$$*/>,
                      TreeNode,
                      C>
                  instanceCtor) {
    return new /*$$TypeClassName*/ StableProfileSchemaTemplate /*$$*/<>(
        /*$$Fields*/ fieldSchema1, fieldSchema2 /*$$*/, maxFieldCount) {
      @Override
  ...
  protected /*$$TypeClassName*/ StableProfileSchemaTemplate /*$$*/(
    ...
    super(
        "",
        continuousActiveSchemas(List.of(/*$$Fields*/ fieldSchema1, fieldSchema2 /*$$*/)),
        maxFieldCount);
  }
