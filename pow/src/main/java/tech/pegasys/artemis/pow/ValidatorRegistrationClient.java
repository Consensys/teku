...
public class ValidatorRegistrationClient {
    ...
    public void listenToPoWChain() {
        ...
        eth1DepositSub =
                contract.eth1DepositEventObservable(filter)
                        .subscribe(
                                response -> {
        ...
        // ValidatorRegistrationContract
        chainStartSub =
                contract.chainStartEventObservable(filter)
                        .subscribe(
                                response -> {
    ...
    public ValidatorRegistrationContract deployVRC(Web3j web3j, Credentials credentials) {
        ...
        try {
            contract =
                    ValidatorRegistrationContract.deploy(web3j, credentials, contractGasProvider)
                            .send();
        } catch (Exception e) {
    ...
    public void validatorRegistered(
