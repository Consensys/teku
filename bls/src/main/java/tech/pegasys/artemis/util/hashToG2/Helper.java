...
import static tech.pegasys.artemis.util.hashToG2.Consts.iwsc;
import static tech.pegasys.artemis.util.hashToG2.Consts.k_cx;
import static tech.pegasys.artemis.util.hashToG2.Consts.k_cy;
import static tech.pegasys.artemis.util.hashToG2.Consts.k_qi_x;
import static tech.pegasys.artemis.util.hashToG2.Consts.k_qi_y;
...
class Helper {
   ...
   * has expired, the endomorphism can be implemented here.
   *
   ...
   * @return a corresponding point in the G2 group
   */
  static JacobianPoint clear_h2_fast(JacobianPoint p) {
    // (-x + 1) P
