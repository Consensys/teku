...
public abstract class ContainerType4<
  ...
  public static <
          ...
          V2 extends SszData,
          V3 extends SszData>
      ContainerType4<C, V0, V1, V2, V3> create(
          SszSchema<V0> fieldType0,
          SszSchema<V1> fieldType1,
          SszSchema<V2> fieldType2,
          SszSchema<V3> fieldType3,
          BiFunction<ContainerType4<C, V0, V1, V2, V3>, TreeNode, C> instanceCtor) {
    return new ContainerType4<>(fieldType0, fieldType1, fieldType2, fieldType3) {
      @Override
  ...
  protected ContainerType4(
      SszSchema<V0> fieldType0,
      SszSchema<V1> fieldType1,
      SszSchema<V2> fieldType2,
      SszSchema<V3> fieldType3) {

    super(List.of(fieldType0, fieldType1, fieldType2, fieldType3));
  }
  ...
  protected ContainerType4(
    ...
    super(
        containerName, List.of(fieldNamedType0, fieldNamedType1, fieldNamedType2, fieldNamedType3));
  }
