...
public class Container8<
  ...
  protected Container8(ContainerType8<C, V0, V1, V2, V3, V4, V5, V6, V7> type) {
    super(type);
  }

  protected Container8(
      ContainerType8<C, V0, V1, V2, V3, V4, V5, V6, V7> type, TreeNode backingNode) {
    super(type, backingNode);
  }

  protected Container8(
      ContainerType8<C, V0, V1, V2, V3, V4, V5, V6, V7> type,
      V0 arg0,
      V1 arg1,
      V2 arg2,
      V3 arg3,
      ...
      V6 arg6,
      V7 arg7) {
    super(type, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
  }
