...
public abstract class ContainerType13<
  ...
  public static <
          ...
          V11 extends ViewRead,
          V12 extends ViewRead>
      ContainerType13<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12> create(
          ...
          BiFunction<
                  ContainerType13<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12>,
                  TreeNode,
                  C>
              instanceCtor) {
    return new ContainerType13<>(
        fieldType0,
        fieldType1,
        fieldType2,
        fieldType3,
