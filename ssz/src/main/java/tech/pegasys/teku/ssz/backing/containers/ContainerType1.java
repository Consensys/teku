...
public abstract class ContainerType1<C extends ContainerViewRead, V0 extends SszData>
    extends ContainerViewType<C> {

  public static <C extends ContainerViewRead, V0 extends SszData> ContainerType1<C, V0> create(
