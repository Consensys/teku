...
public abstract class ContainerType1<C extends SszContainer, V0 extends SszData>
    extends ContainerViewType<C> {

  public static <C extends SszContainer, V0 extends SszData> ContainerType1<C, V0> create(
      SszSchema<V0> fieldType0, BiFunction<ContainerType1<C, V0>, TreeNode, C> instanceCtor) {
  ...
  protected ContainerType1(SszSchema<V0> fieldType0) {
