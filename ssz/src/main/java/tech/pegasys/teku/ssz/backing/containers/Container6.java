...
public class Container6<
  ...
  protected Container6(ContainerType6<C, V0, V1, V2, V3, V4, V5> type) {
    super(type);
  }

  protected Container6(ContainerType6<C, V0, V1, V2, V3, V4, V5> type, TreeNode backingNode) {
    super(type, backingNode);
  }

  protected Container6(
      ContainerType6<C, V0, V1, V2, V3, V4, V5> type,
      V0 arg0,
      V1 arg1,
      V2 arg2,
      V3 arg3,
      V4 arg4,
      V5 arg5) {
    super(type, arg0, arg1, arg2, arg3, arg4, arg5);
  }
