...
public class VotesTest {
  ...
  void votesTest() {
    ...
    ProtoArrayForkChoiceStrategy forkChoice = createProtoArrayForkChoiceStrategy(getHash(0), ZERO, ONE, ONE);
    ...
    assertThat(
            forkChoice.applyPendingVotes(store, ONE, getHash(0), ONE, balances, proposerWeightings))
        .isEqualTo(getHash(0));
