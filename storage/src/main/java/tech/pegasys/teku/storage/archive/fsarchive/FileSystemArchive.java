...
/**
 * A file system based implementations of the DataArchive.
 * Writes to a directory using the PathResolver method to decide where to write the files.
 */
public class FileSystemArchive implements DataArchive, DataArchiveWriterFactory {
    ...
    /**
     * Given a basePath, slot and block root, return where to store/find the BlobSidecar.
     * Initial implementation uses blockRoot as a hex string in the directory of the first
     * two characters.
     *
    ...
    File resolve(final Path basePath, final SlotAndBlockRoot slotAndBlockRoot) {
        ...
        final String blobSidecarFilename = dir1 + File.pathSeparator + dir2 + File.pathSeparator + blockRootString ;
