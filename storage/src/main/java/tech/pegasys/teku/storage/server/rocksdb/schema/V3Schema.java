...
public interface V3Schema extends Schema {
  ...
  RocksDbColumn<BLSPublicKey, UnsignedLong> PUBLIC_KEY_TO_LAST_SIGNED_BLOCK_SLOT =
      RocksDbColumn.create(10, PUBLIC_KEY_SERIALIZER, UNSIGNED_LONG_SERIALIZER);
  RocksDbColumn<BLSPublicKey, SignedAttestationRecord> PUBLIC_KEY_TO_SIGNED_ATTESTATION_RECORD =
      RocksDbColumn.create(11, PUBLIC_KEY_SERIALIZER, SIGNED_ATTESTATION_RECORD_SERIALIZER);
