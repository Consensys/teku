...
public class CombinedChainDataClient {
  ...
  private static final GoodFuture<Optional<BeaconBlock>> BLOCK_NOT_AVAILABLE =
   ...
   */
  public GoodFuture<Optional<BeaconBlock>> getBlockAtSlotExact(
   ...
   */
  public GoodFuture<Optional<BeaconBlock>> getBlockInEffectAtSlot(
      final UnsignedLong slot, final Bytes32 headBlockRoot) {
  ...
  private GoodFuture<Optional<BeaconBlock>> getBlockAtSlotFormHistoricalBlockRoots(
