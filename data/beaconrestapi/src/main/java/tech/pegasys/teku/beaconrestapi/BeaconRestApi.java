...
public class BeaconRestApi {
  ...
  private void addV1BeaconHandlers(final DataProvider dataProvider) {
    ...
    app.get(tech.pegasys.teku.beaconrestapi.handlers.v1.beacon.GetStateRoot.ROUTE, new tech.pegasys.teku.beaconrestapi.handlers.v1.beacon.GetStateRoot(dataProvider, jsonProvider));
