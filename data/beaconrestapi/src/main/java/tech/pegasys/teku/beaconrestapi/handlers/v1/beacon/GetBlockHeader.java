...
import static tech.pegasys.teku.ethereum.json.types.SharedApiTypes.GET_BLOCK_HEADER_RESPONSE_TYPE;
  ...
  public GetBlockHeader(final ChainDataProvider chainDataProvider) {
    super(
        EndpointMetadata.get(ROUTE)
            ...
            .response(SC_OK, "Request successful", GET_BLOCK_HEADER_RESPONSE_TYPE)
