...
public class GetStateEpochCommittees extends AbstractHandler implements Handler {
  ...
  public void handle(@NotNull final Context ctx) throws Exception {
    ...
    final Optional<UInt64> slotQueryParam =
        getParameterValueAsUInt64IfPresent(queryParameters, SLOT);
    final Optional<Integer> indexQueryParam =
        getParameterValueAsIntIfPresent(queryParameters, INDEX);
