...
public class GetBlockAttestations extends AbstractHandler implements Handler {
  ...
  public void handle(@NotNull final Context ctx) throws Exception {
    final Function<UInt64, SafeFuture<Optional<List<Attestation>>>> slotHandler =
            chainDataProvider::getBlockAttestationsBySlot;
    final Function<Bytes32, SafeFuture<Optional<List<Attestation>>>> rootHandler =
            chainDataProvider::getBlockAttestationsByRoot;
