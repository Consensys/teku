...
import static tech.pegasys.teku.ethereum.json.types.validator.InclusionList.INCLUSIOIN_LIST_TYPE;
import static tech.pegasys.teku.ethereum.json.types.validator.InclusionList.INCLUSION_LIST_TYPE;
...
public class PostInclusionList extends RestApiEndpoint {
    ...
    public PostInclusionList(DataProvider dataProvider) {
        this(dataProvider.getSyncDataProvider(), dataProvider.getValidatorDataProvider());
    }

    public PostInclusionList(final SyncDataProvider syncDataProvider, final ValidatorDataProvider validatorDataProvider) {
        super(
                EndpointMetadata.get(ROUTE)
                        ...
                        .requestBodyType(INCLUSION_LIST_TYPE)
