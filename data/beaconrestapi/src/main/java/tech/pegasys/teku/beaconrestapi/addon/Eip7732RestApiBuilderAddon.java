...
import tech.pegasys.teku.beaconrestapi.handlers.v1.beacon.GetExecutionPayload;
import tech.pegasys.teku.infrastructure.restapi.RestApiBuilder;
import tech.pegasys.teku.spec.Spec;
import tech.pegasys.teku.spec.SpecMilestone;
import tech.pegasys.teku.spec.schemas.SchemaDefinitionCache;

public class Eip7732RestApiBuilderAddon implements RestApiBuilderAddon {

  final Spec spec;
  final DataProvider dataProvider;
  final SchemaDefinitionCache schemaCache;

  public Eip7732RestApiBuilderAddon(
  ...
  public boolean isEnabled() {
    return spec.isMilestoneSupported(SpecMilestone.EIP7732);
  }

  @Override
  public RestApiBuilder apply(final RestApiBuilder builder) {
    return builder.endpoint(new GetExecutionPayload(dataProvider, schemaCache));
  }
}
