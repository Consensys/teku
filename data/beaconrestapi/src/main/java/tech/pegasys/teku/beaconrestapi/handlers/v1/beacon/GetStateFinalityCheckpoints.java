...
public class GetStateFinalityCheckpoints extends AbstractHandler implements Handler {
  ...
  public GetStateFinalityCheckpoints(final DataProvider dataProvider, final JsonProvider jsonProvider) {
    super(jsonProvider);
    this.chainDataProvider = dataProvider.getChainDataProvider();
  }

  GetStateFinalityCheckpoints(final ChainDataProvider chainDataProvider, final JsonProvider jsonProvider) {
    super(jsonProvider);
  ...
  private Optional<String> handleResult(Context ctx, final BeaconState response)
    ...
    FinalityCheckpointsResponse finalityCheckpointsResponse = new FinalityCheckpointsResponse(
    ...
    return Optional.of(jsonProvider.objectToJSON(new GetStateFinalityCheckpointsResponse(finalityCheckpointsResponse)));
  }
}
