...
import tech.pegasys.teku.ethereum.json.types.validator.AttesterDutiesBuilder;
  ...
  PostAttesterDuties(
    ...
    super(
        EndpointMetadata.post(ROUTE)
            ...
            .response(
                SC_OK, "Success response", AttesterDutiesBuilder.ATTESTER_DUTIES_RESPONSE_TYPE)
