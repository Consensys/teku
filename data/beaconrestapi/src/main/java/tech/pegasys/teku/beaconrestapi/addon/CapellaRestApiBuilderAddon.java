...
public class CapellaRestApiBuilderAddon implements RestApiBuilderAddon {

  final Spec spec;
  final DataProvider dataProvider;
  final SchemaDefinitionCache schemaCache;

  public CapellaRestApiBuilderAddon(
  ...
  public boolean isEnabled() {
    return spec.isMilestoneSupported(SpecMilestone.CAPELLA);
  }
