...
public class DenebRestApiBuilderAddon implements RestApiBuilderAddon {

  final Spec spec;
  final DataProvider dataProvider;
  final SchemaDefinitionCache schemaCache;

  public DenebRestApiBuilderAddon(
  ...
  public boolean isEnabled() {
    return spec.isMilestoneSupported(SpecMilestone.DENEB);
  }
  ...
  public RestApiBuilder apply(final RestApiBuilder builder) {
    return builder
        ...
        .endpoint(new GetBlobs(dataProvider, schemaCache))
