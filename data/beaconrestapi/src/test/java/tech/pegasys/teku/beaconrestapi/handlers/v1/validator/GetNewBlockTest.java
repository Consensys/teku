...
public class GetNewBlockTest extends AbstractMigratedBeaconHandlerTest {
  ...
  void metadata_shouldHandle200() throws IOException {
    final BeaconBlock responseData = dataStructureUtil.randomBeaconBlock(1);

    final String data = getResponseStringFromMetadata(handler, SC_OK, responseData);
    final String expected =
        Resources.toString(Resources.getResource(GetNewBlockTest.class, "getNewBlock.json"), UTF_8);
