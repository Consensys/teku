...
public class GetBlockTest extends AbstractBeaconHandlerTest {
  private final DataStructureUtil dataStructureUtil = new DataStructureUtil();
  private final GetBlock handler = new GetBlock(chainDataProvider, jsonProvider);
  private final SignedBeaconBlock signedBeaconBlock =
      new SignedBeaconBlock(dataStructureUtil.randomSignedBeaconBlock(1));

  @Test
  public void shouldGetBlockBySlot() throws Exception {
