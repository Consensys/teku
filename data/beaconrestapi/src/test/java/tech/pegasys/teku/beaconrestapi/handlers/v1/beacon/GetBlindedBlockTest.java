...
class GetBlindedBlockTest extends AbstractMigratedBeaconHandlerWithChainDataProviderTest {
  ...
  @Test
  void shouldReturnBlindedBlockInformation()
      throws JsonProcessingException, ExecutionException, InterruptedException {
    final ObjectAndMetaData<SignedBeaconBlock> blockAndMetaData =
        chainDataProvider.getBlindedBlock("head").get().orElseThrow();
