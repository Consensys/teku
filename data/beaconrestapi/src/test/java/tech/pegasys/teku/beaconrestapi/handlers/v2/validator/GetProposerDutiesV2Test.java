...
public class GetProposerDutiesV2Test extends AbstractMigratedBeaconHandlerTest {
  ...
  @BeforeEach
  void setUp() {
    setHandler(new GetProposerDutiesV2(syncDataProvider, validatorDataProvider));
  }
