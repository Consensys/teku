...
class GetDebugStateTest extends AbstractMigratedBeaconHandlerWithChainDataProviderTest {
  ...
  void setup() {
    ...
    setHandler(new GetDebugState(chainDataProvider, schemaDefinitionCache));
  ...
  void metadata_shouldHandle200() throws IOException {
    ...
    final String expected =
        Resources.toString(
            Resources.getResource(GetDebugStateTest.class, "getDebugState.json"), UTF_8);
