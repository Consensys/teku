...
public class BeaconBlockBodyBellatrixTest {
  ...
  void asInternalBeaconBlockBody_ShouldConvertBellatrixBlock() {
    ...
    assertThat(block).isInstanceOf(BeaconBlockBellatrix.class);
