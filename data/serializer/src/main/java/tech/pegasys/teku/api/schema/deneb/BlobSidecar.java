...
public class BlobSidecar {
  ...
  @Schema(name = "block_root", type = "string", format = "byte", description = DESCRIPTION_BYTES32)
  public final Bytes32 blockRoot;
  ...
  @Schema(
      name = "block_parent_root",
      type = "string",
      format = "byte",
      description = DESCRIPTION_BYTES32)
  public final Bytes32 blockParentRoot;
  ...
  public final KZGCommitment kzgCommitment;

  @JsonProperty("kzg_proof")
  @Schema(type = "string", format = "byte", description = DESCRIPTION_BYTES48)
  public final KZGProof kzgProof;
  ...
  public BlobSidecar(
      ...
      @JsonProperty("kzg_commitment") final KZGCommitment kzgCommitment,
      @JsonProperty("kzg_proof") final KZGProof kzgProof) {
  ...
  public BlobSidecar(
    ...
    this.kzgCommitment = new KZGCommitment(blobSidecar.getKZGCommitment());
    this.kzgProof = new KZGProof(blobSidecar.getKZGProof());
  }
  ...
  public tech.pegasys.teku.spec.datastructures.blobs.versions.deneb.BlobSidecar
    ...
    return schema.create(
        ...
        blockParentRoot,
        proposerIndex,
        schema.getBlobSchema().create(blob),
