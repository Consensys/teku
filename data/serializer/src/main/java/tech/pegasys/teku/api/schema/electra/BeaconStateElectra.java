...
public class BeaconStateElectra extends BeaconStateAltair {
  ...
  public ExecutionPayloadHeaderElectra latestExecutionPayloadHeader;
  ...
  public BeaconStateElectra(BeaconState beaconState) {
    super(beaconState);
            ...
            builder ->
                builder
                    ...
                    .executionWitnessRoot(
                        () -> instance.latestExecutionPayloadHeader.executionWitnessRoot)));
