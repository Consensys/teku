...
public class SignedBlobSidecars {
  ...
  public SignedBlobSidecars(
      final tech.pegasys.teku.spec.datastructures.blobs.versions.deneb.SignedBlobSidecars
          signedBlobSidecars) {
  ...
  public static SignedBlobSidecars create(
      final List<tech.pegasys.teku.spec.datastructures.blobs.versions.deneb.SignedBlobSidecar>
          signedBlobSidecars) {
    return new SignedBlobSidecars(
        signedBlobSidecars.stream().map(SignedBlobSidecar::new).collect(Collectors.toList()));
  }

  public tech.pegasys.teku.spec.datastructures.blobs.versions.deneb.SignedBlobSidecars
