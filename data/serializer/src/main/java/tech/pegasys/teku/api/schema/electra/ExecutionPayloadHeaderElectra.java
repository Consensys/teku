...
public class ExecutionPayloadHeaderElectra extends ExecutionPayloadHeaderCapella {

  @JsonProperty("execution_witness_root")
  @Schema(type = "string", format = "byte", description = DESCRIPTION_BYTES32)
  public final Bytes32 executionWitnessRoot;
  ...
  public ExecutionPayloadHeaderElectra(
      ...
      @JsonProperty("execution_witness_root") Bytes32 executionWitnessRoot) {
    super(
        parentHash,
        feeRecipient,
        stateRoot,
        ...
        transactionsRoot,
        withdrawalsRoot);
    this.executionWitnessRoot = executionWitnessRoot;
  }

  public ExecutionPayloadHeaderElectra(ExecutionPayloadHeader executionPayloadHeader) {
    super(
    ...
    this.executionWitnessRoot =
        executionPayloadHeader
            .toVersionElectra()
            .map(
                tech.pegasys.teku.spec.datastructures.execution.versions.electra
  ...
  public boolean equals(final Object o) {
    ...
    final ExecutionPayloadHeaderElectra that = (ExecutionPayloadHeaderElectra) o;
    return Objects.equals(executionWitnessRoot, that.executionWitnessRoot);
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), executionWitnessRoot);
  }
