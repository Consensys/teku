...
public class ExecutionPayloadElectra extends ExecutionPayloadCapella {

  @JsonProperty("execution_witness")
  ...
  public ExecutionPayloadElectra(ExecutionPayload executionPayload) {
    super(executionPayload);
    this.executionWitness =
        executionPayload
            .toVersionElectra()
            .map(electraHeader -> electraHeader.getExecutionWitness().sszSerialize())
            .orElse(null);
  }
  ...
  public boolean equals(final Object o) {
    ...
    final ExecutionPayloadElectra that = (ExecutionPayloadElectra) o;
    return Objects.equals(executionWitness, that.executionWitness);
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), executionWitness);
  }
