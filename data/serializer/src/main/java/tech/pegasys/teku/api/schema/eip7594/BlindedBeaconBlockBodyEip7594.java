...
import tech.pegasys.teku.spec.datastructures.blocks.blockbody.versions.eip7594.BlindedBeaconBlockBodySchemaEip7594;
...
public class BlindedBeaconBlockBodyEip7594 extends BeaconBlockBodyAltair {
  ...
  public final ExecutionPayloadHeaderEip7594 executionPayloadHeader;
  ...
  public BlindedBeaconBlockBodyEip7594(
      ...
      @JsonProperty("execution_payload_header")
          final ExecutionPayloadHeaderEip7594 executionPayloadHeader,
      @JsonProperty("bls_to_execution_changes")
    ...
    super(
        ...
        syncAggregate);
    checkNotNull(
        executionPayloadHeader, "Execution Payload Header is required for EIP7594 blinded blocks");
    this.executionPayloadHeader = executionPayloadHeader;
    checkNotNull(
        blsToExecutionChanges, "blsToExecutionChanges is required for EIP7594 blinded blocks");
    this.blsToExecutionChanges = blsToExecutionChanges;
    checkNotNull(blobKZGCommitments, "blobKZGCommitments is required for EIP7594 blinded blocks");
    this.blobKZGCommitments = blobKZGCommitments;
  }

  public BlindedBeaconBlockBodyEip7594(
      final tech.pegasys.teku.spec.datastructures.blocks.blockbody.versions.eip7594
              .BlindedBeaconBlockBodyEip7594
          blockBody) {
    super(blockBody);
    this.executionPayloadHeader =
        new ExecutionPayloadHeaderEip7594(blockBody.getExecutionPayloadHeader());
  ...
  @Override
  public BlindedBeaconBlockBodySchemaEip7594<?> getBeaconBlockBodySchema(final SpecVersion spec) {
    return (BlindedBeaconBlockBodySchemaEip7594<?>)
