...
public class BlindedBlockEip4844 extends BeaconBlockAltair {

  public BlindedBlockEip4844(final BeaconBlock message) {
    super(
        message.getSlot(),
        message.getProposerIndex(),
        message.getParentRoot(),
        message.getStateRoot(),
        new BlindedBeaconBlockBodyEip4844(
            message.getBody().toBlindedVersionEip4844().orElseThrow()));
  }
  ...
  @JsonProperty("body")
  @Override
  public BlindedBeaconBlockBodyEip4844 getBody() {
    return (BlindedBeaconBlockBodyEip4844) body;
  }

  @JsonCreator
  public BlindedBlockEip4844(
      ...
      @JsonProperty("body") final BlindedBeaconBlockBodyEip4844 body) {
