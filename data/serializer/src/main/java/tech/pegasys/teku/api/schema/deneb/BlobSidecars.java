...
public class BlobSidecars {
  ...
  public BlobSidecars(
      final tech.pegasys.teku.spec.datastructures.blobs.versions.deneb.BlobSidecars blobSidecars) {
    this.blobSidecars =
  ...
  public tech.pegasys.teku.spec.datastructures.blobs.versions.deneb.BlobSidecars
