...
public class DepositTreeSnapshotData {
  private final List<Bytes32> finalized;
  private final UInt64 deposits;
  private final Bytes32 executionBlockHash;

  public DepositTreeSnapshotData(final DepositTreeSnapshot depositTreeSnapshot) {
    this.finalized = depositTreeSnapshot.getFinalized();
    this.deposits = UInt64.valueOf(depositTreeSnapshot.getDeposits());
    this.executionBlockHash = depositTreeSnapshot.getExecutionBlockHash();
  }

  public DepositTreeSnapshotData(
      List<Bytes32> finalized, UInt64 deposits, Bytes32 executionBlockHash) {
  ...
  public boolean equals(Object o) {
    ...
    DepositTreeSnapshotData that = (DepositTreeSnapshotData) o;
    return Objects.equals(finalized, that.finalized)
