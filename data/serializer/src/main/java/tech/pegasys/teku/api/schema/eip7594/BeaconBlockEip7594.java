...
public class BeaconBlockEip7594 extends BeaconBlockAltair {

  public BeaconBlockEip7594(final BeaconBlock message) {
    super(
        message.getSlot(),
  ...
  public BeaconBlock asInternalBeaconBlock(final Spec spec) {
    ...
    return SchemaDefinitionsEip7594.required(specVersion.getSchemaDefinitions())
