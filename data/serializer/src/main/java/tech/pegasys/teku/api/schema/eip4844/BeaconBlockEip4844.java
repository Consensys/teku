...
public class BeaconBlockEip4844 extends BeaconBlockAltair {

  public BeaconBlockEip4844(final BeaconBlock message) {
    super(
        message.getSlot(),
        message.getProposerIndex(),
        message.getParentRoot(),
        message.getStateRoot(),
        new BeaconBlockBodyEip4844(message.getBody().toVersionEip4844().orElseThrow()));
  }
  ...
  @JsonProperty("body")
  @Override
  public BeaconBlockBodyEip4844 getBody() {
    return (BeaconBlockBodyEip4844) body;
  }

  @JsonCreator
  public BeaconBlockEip4844(
      ...
      @JsonProperty("body") final BeaconBlockBodyEip4844 body) {
