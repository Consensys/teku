...
/**
 * Handles containers (aka structures or ordered heterogenous collection of values), is responsible
 * of accessing its child values, their types and new instance creation
 */
