...
public class QuartzTimerService extends Service {
  ...
  public QuartzTimerService(final TimeTickHandler timeTickHandler) {
    ...
    try {
      ...
      throw new IllegalArgumentException("QuartzTimerService failed to initialize", e);
    }
  }
  ...
  public SafeFuture<?> doStart() {
    try {
      ...
      return SafeFuture.failedFuture(new RuntimeException("QuartzTimerService failed to start", e));
    }
  }
  ...
  public SafeFuture<?> doStop() {
    try {
      ...
      return SafeFuture.failedFuture(new RuntimeException("QuartzTimerService failed to stop", e));
    }
  }
}
