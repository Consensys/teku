...
import tech.pegasys.teku.ethereum.executionlayer.client.Web3jClientBuilder;
...
public class TrustedExecutionClientProvider implements ExecutionClientProvider {
  ...
  public Optional<Web3JClient> getWeb3JClient() {
    buildClient();
    return Optional.of(web3JClient);
  }

  @Override
  public Optional<Web3j> getWeb3j() {
    buildClient();
    return Optional.of(web3JClient.getEth1Web3j());
  }

  @Override
  public Optional<String> getEndpoint() {
    return Optional.of(eeEndpoint);
  }
}
