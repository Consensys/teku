...
public class UInt64Test {
  ...
  public void addUnsigned() {
    ...
    assertEquals("UInt64.MAX_VALUE + 1", "0", uSum.toString());
  }
  ...
  public void subtractUnsigned() {
    ...
    assertEquals("UInt64.MAX_VALUE - 1", "18446744073709551614", uDifference.toString());
  }
  ...
  public void multiplyUnsigned() {
    ...
    assertEquals("UInt64.MAX_VALUE * 1", "18446744073709551615", uProduct.toString());
    // 2^64-1 * 0 = 0
    UInt64 uProductZero = UInt64.MAX_VALUE.times(0);
    assertEquals("UInt64.MAX_VALUE * 0", "0", uProductZero.toString());
  }
  ...
  public void divideUnsigned() {
    ...
    assertEquals("UInt64.MAX_VALUE / 1", "18446744073709551615", uQuotient.toString());
    // 2^64-1 / 2 = 2^63-1
    UInt64 uQuotientMax = UInt64.MAX_VALUE.dividedBy(2);
    assertEquals("UInt64.MAX_VALUE / 2", "9223372036854775807", uQuotientMax.toString());
  }
  ...
  public void moduloUnsigned() {
    ...
    assertEquals("UInt64.MAX_VALUE % 1", "0", uQuotient.toString());
    // 2^64-1 % 2 = 1
    UInt64 uQuotientMax = UInt64.MAX_VALUE.modulo(2);
    assertEquals("UInt64.MAX_VALUE % 2", "1", uQuotientMax.toString());
  }

  @Test
  public void saturationAddition() {
    assertEquals(UInt64.MAX_VALUE, UInt64.MAX_VALUE.plusSat(1));
    assertEquals(UInt64.MAX_VALUE, UInt64.MAX_VALUE.dividedBy(2).plusSat(UInt64.MAX_VALUE));
    assertEquals(UInt64.MAX_VALUE.dividedBy(2), UInt64.MAX_VALUE.dividedBy(2).plusSat(UInt64.ZERO));
    assertEquals(UInt64.MAX_VALUE.dividedBy(2).plus(10), UInt64.MAX_VALUE.dividedBy(2).plusSat(10));
  }

  @Test
  public void saturationSubtraction() {
    assertEquals(UInt64.MIN_VALUE, UInt64.MIN_VALUE.minusSat(1));
    assertEquals(UInt64.MIN_VALUE, UInt64.MAX_VALUE.dividedBy(2).minusSat(UInt64.MAX_VALUE));
    assertEquals(
  ...
  private void add(long augend, long addend, String expectedSum) {
    ...
    try {
      ...
      //      assertEquals("Sum", expectedSum, Long.toUnsignedString(longSum.getValue()));
      //      assertEquals("UInt64 Sum", UInt64.valueOf(expectedSum), longSum);

      UInt64 uAddend = UInt64.valueOf(addend);
      UInt64 uintSum = uAugend.plus(uAddend);
      //      assertEquals("Sum", expectedSum, Long.toUnsignedString(uintSum.getValue()));
      //      assertEquals("UInt64 Sum", UInt64.valueOf(expectedSum), uintSum);
    } catch (Exception e) {
      thrown = true;
    }

    //    assertEquals("Addition should not have thrown an exception.", false, thrown);
  }
  ...
  private void subtract(long minuend, long subtrahend, String expectedDifference) {
    ...
    try {
      ...
      // Long.toUnsignedString(longDifference.getValue()));
      //      assertEquals("UInt64 Difference", UInt64.valueOf(expectedDifference), longDifference);

      UInt64 uSubtrahend = UInt64.valueOf(subtrahend);
      UInt64 uintDifference = uMinuend.minus(uSubtrahend);
      //      assertEquals(
      //          "Difference", expectedDifference,
      // Long.toUnsignedString(uintDifference.getValue()));
      //      assertEquals("UInt64 Difference", UInt64.valueOf(expectedDifference), uintDifference);
    } catch (Exception e) {
      thrown = true;
    }

    //    assertEquals("Subtraction should not have thrown an exception.", false, thrown);
  }
  ...
  private void multiply(long multiplicand, long multiplier, String expectedProduct) {
    ...
    try {
      ...
      //      assertEquals("UInt64 Product", UInt64.valueOf(expectedProduct), longProduct);
      ...
      //      assertEquals("UInt64 Product", UInt64.valueOf(expectedProduct), uintProduct);
    } catch (Exception e) {
      thrown = true;
    }

    //    assertEquals("Multiplication should not have thrown an exception.", false, thrown);
  }
  ...
  private void divideExpectException(
    ...
    try {
      ...
      //      assertTrue(
      //          "Division operation was expected to throw an exception of type
      // IllegalArgumentException.",
      //          e instanceof IllegalArgumentException);
      //      assertTrue(
      //          "Exception message was not correct.", e.getMessage().equals("Argument 'divisor' is
      // 0."));
    }
  }
  ...
  private void divideExpectResult(
    ...
    try {
      ...
      if (isModulo) {
        ...
        //        assertEquals("UInt64 Modulo Result", UInt64.valueOf(expectedQuotient),
        // longQuotient);
    ...
    //    assertEquals("Division should not have thrown an exception.", false, thrown);
  }
}
